...
<head>
    ...
    <script>
        ...
        var customerInfo = {
            ...
            "guest": 1,
            "isNew": 1,
            "privilege": {"has_discount88": false, "has_pass_card": false, "has_visa_discount83": false, "bit_map": 0},
            "balance": {"cashback": 0},
            "order": {"finish_count": 0}
        };
        //某些商品特殊餐具数量
...
<script>
    ...
    var orderInfo = {
        ...
        "promo_use_type": 0,
        "stock_config": {"error": "0", "data": {"is_limited": false, "filter_period": [], "matched_list": null}},
        "time_config": {
        ...
        "promo_flag": 3145743,
        "deliver_type": 1,
        "user": {"privilege": 0, "balance": {"cashback": 0}},
        "max_pay_cashback": 0,
        "max_invoice_amount": 594,
        "sku_list": [{
            "sku_id": 106131,
            "amount": 1,
            "seqno": 0,
            "checked": 0,
            "attributes": {"goods_cut": null, "goods_birthday": ""},
            "goods_name": "\u6570\u5b57\u86cb\u7cd5\uff08\u6570\u5b575\uff09",
            "english_name": "",
            "spec": "1\u78c5",
            "display_spec": "2-4\u4eba\u98df",
            ...
            "birthday_flag": 1,
            "goodscut_flag": 0,
            "standard_fitting": {"cp": 5, "lz": 1, "dc": 1},
            "main_pic": "201803\/16192\/list_16192.jpg?v=1522743650",
            "loukou_pic": "10523636061251B9AA634A2B1DB60DE0.jpg",
            "buy_price": 198,
            "specialDinnerware": ""
        }, {
            "sku_id": 106135,
    ...
    function udeskLoad() {
        if (!udeskReady) {
            ...
            ud({
                ...
                "customer": {
                    "nonce": "ZkD19KhylNXREk2h",
                    "timestamp": 1541838795859,
                    "web_token": "7531703",
                    "signature": "BB370EA12CAE37CD1D0E54F385DDCC910CD46316",
                    "c_cn_pcustID": "7531703",
                    "c_cn_clickID": "KyOLmxh3hJV.",
