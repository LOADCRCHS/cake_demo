...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHdoJIwEpBL"};</script>
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            </div><div class="blank1"></div>
            <div class="zhangCheng">
                <img src="<%=request.getContextPath()%>/static/picture/1.png" />
                <img src="<%=request.getContextPath()%>/static/picture/2.jpg" />
                <img src="<%=request.getContextPath()%>/static/picture/new_3.jpg" />
                <img src="<%=request.getContextPath()%>/static/picture/4.jpg" />
                <img src="<%=request.getContextPath()%>/static/picture/new_5.jpg" />
                <img src="<%=request.getContextPath()%>/static/picture/6.jpg" />
                <img src="<%=request.getContextPath()%>/static/picture/7.png" />
            </div>
