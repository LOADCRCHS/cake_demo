...
<meta http-equiv="Content-Language" content="zh-CN" />
			<title>关于诺心-诺心LECAKE</title>
		<meta name="Keywords" content="诺心线上蛋糕,诺心食材,诺心简介" />
...
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhq4M98piA"};</script>
...
.top_box {
	background-image: url(../static/images/gvnx1.gif
);
...
.foot_box{
	background-image: url(../static/images/gvnx5.gif);
	background-repeat: no-repeat;
	height: 415px;
	width: 981px;
}
...
.box_left {
	background-image: url(../static/images/gvnx2.gif);
	background-repeat: no-repeat;
	height: 219px;
	width: 294px;
	float: left;
...
.box_middle {
	background-image: url(../static/images/gvnx4.gif);
	background-repeat: no-repeat;
	height: 219px;
	width: 394px;
	float: left;
...
.box_right {
	background-image: url(../static/images/gvnx3.gif);
	background-repeat: no-repeat;
	height: 219px;
	width: 292px;
	float: left;
...
.box_cake .cake_list IMG {
	height: 196px;
	width: 280px;
}
.box_cake .cake_list SPAN {
	display: block;
	text-align: center;
	font-size: 12px;
	color: #595959;
...
<div class="clear">&nbsp;</div>
<div class="box"><a target="_blank" href="/shop/goods-100802.html">
...
<div class="clear">&nbsp;</div>
<div class="box_cake">
<div class="cake_list"><a target="_blank" href="/shop/goods-100801.html"><img alt="" src="../static/picture/list_10800.jpg" /><span>雪域牛乳芝士蛋糕</span></a></div>
<div class="cake_list"><a target="_blank" href="/shop/goods-106135.html"><img height="1" alt="" src="../static/picture/pc.jpg" /><span>数字蛋糕</span></a></div>
<div class="cake_list"><a target="_blank" href="/shop/goods-105412.html"><img src="../static/picture/list_15474.jpg" alt="" /><span>美刀刀蛋糕</span></a></div>
</div>
<div class="clear">&nbsp;</div>
<script>
	if(!isLecakeCNDomain){
		$('.top_box').css({'background':'url("../static/images/gvnx.gif")'});
	}
</script>
