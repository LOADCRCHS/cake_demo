...
<head>
    ...
    <!--解决IE6不支持png图片透明问题-->
    <!--[if IE 6]>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/dd_belatedpng.js"></script>
    <script type="text/javascript">
        DD_belatedPNG.fix('*');
    </script>
    <![endif]-->
    <!--/解决IE6不支持png图片透明问题-->
    <link type="text/css" href="${pageContext.request.contextPath}/static/css/comm_header.css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/tnstyle.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/tnheadandfootstyle.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/tnindexstyle.css"/>
    <!----样式按此顺序排放------>
    <script type="text/javascript">var glbStatConfig = {stat_host: "res.lecake.com", click_id: "KyiQ6fsx6Wkp"};</script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/tnlecakeindex.js"></script>

    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/base.css">
    <link type="text/css" href="${pageContext.request.contextPath}/static/css/widget.css" rel="stylesheet"/>
    <!--[if lt IE 9]>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/html5.min.js"></script>
    <![endif]-->
    <link type="text/css" href="${pageContext.request.contextPath}/static/css/payment.css" rel="stylesheet"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/jscal2.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/border-radius.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/steel.css"/>
    <style type="text/css">
        .countdown_wrap {
            position: relative;
            margin: 50px 0;
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        ;
        xajax.config.requestURI = "/shop/payment.php";
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/xajax_core.js"
            charset="UTF-8"></script>

    <script type='text/javascript' charset='UTF-8'>
        /* <![CDATA[ */
        xajax_do_req_header = function () {
            return xajax.request({xjxfun: 'do_req_header'}, {parameters: arguments});
        };
        xajax_editnewbill = function () {
            return xajax.request({xjxfun: 'editnewbill'}, {parameters: arguments});
        };
        xajax_editbill = function () {
            return xajax.request({xjxfun: 'editbill'}, {parameters: arguments});
        };
        xajax_do_req_bill = function () {
            return xajax.request({xjxfun: 'do_req_bill'}, {parameters: arguments});
        };
        /* ]]> */
    </script>
</head>
...
<div class="TN_topheader hide">
    ...
    <div class="TN_chooseADD">
        <div class="Ndd">
            ...
            <div class="Xadd">
                ...
                <a href="/BJ/index.html" data-site-id="287" onclick="return city.set_city('287','北京市','BJ');"
                   cityFlg="287">北京市</a>
                <a href="/GZ/index.html" data-site-id="420" onclick="return city.set_city('420','广州市','GZ');"
                   cityFlg="420">广州市</a>
                <a href="/NJ/index.html" data-site-id="355" onclick="return city.set_city('355','南京市','NJ');"
                   cityFlg="355">南京市</a>
                <a href="/CD/index.html" data-site-id="449" onclick="return city.set_city('449','成都市','CD');"
                   cityFlg="449">成都市</a>
                <a href="/CQ/index.html" data-site-id="499" onclick="return city.set_city('499','重庆市','CQ');"
                   cityFlg="499">重庆市</a>
                <a href="/SN/index.html" data-site-id="386" onclick="return city.set_city('386','深圳市','SN');"
                   cityFlg="386">深圳市</a>
                <a href="/HZ/index.html" data-site-id="83" onclick="return city.set_city('83','杭州市','HZ');"
                   cityFlg="83">杭州市</a>
                <a href="/SZ/index.html" data-site-id="228" onclick="return city.set_city('228','苏州市','SZ');"
                   cityFlg="228">苏州市</a>
                <a href="/TJ/index.html" data-site-id="334" onclick="return city.set_city('334','天津市','TJ');"
                   cityFlg="334">天津市</a>
                <a href="/NB/index.html" data-site-id="356" onclick="return city.set_city('356','宁波市','NB');"
                   cityFlg="356">宁波市</a>
                <a href="/WX/index.html" data-site-id="261" onclick="return city.set_city('261','无锡市','WX');"
                   cityFlg="261">无锡市</a>
                <a href="/SX/index.html" data-site-id="446" onclick="return city.set_city('446','绍兴市','SX');"
                   cityFlg="446">绍兴市</a>
                <a href="/JX/index.html" data-site-id="447" onclick="return city.set_city('447','嘉兴市','JX');"
                   cityFlg="447">嘉兴市</a>
            </div>
        </div>
    </div>
    ...
    <div class="TN_menu">
        <ul>
            <li class="TN_LEFTone">
                <dt><a href="/"><img alt="首页"
                                     src="${pageContext.request.contextPath}/static/picture/tntoplist1.jpg"></a></dt>
                <!-----首页1----->
                <dd><a href="/"></a></dd>
            </li>
            <li>
                <!---蛋糕馆--->
                <dt><a href="/BJ/category-0-1.html"><img alt="蛋糕馆"
                                                         src="${pageContext.request.contextPath}/static/picture/tntoplist2.jpg"></a>
                </dt>
                <dd><a href="/BJ/category-0-1.html"></a></dd>
                <dt class="TN_drop-down">
                    <div class="TN_drop-down_menuBG" style=" height:370px;"></div>
                    <!----height=170px=40px*4+10px---下拉菜单默认4个，数量改变请同步改变heigh的值------>
                    <div class="TN_drop-down_menu">
                        <p><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_top_little_03.png"
                                width="8" height="4"/></p>
                        <ul class="L">
                            <li><a href="/BJ/category-104-1.html">芝士口味</a>
                            <li><a href="/BJ/category-121-1.html">雪域口味</a>
                            <li><a href="/BJ/category-101-1.html">慕斯口味</a>
                            <li><a href="/BJ/category-103-1.html">巧克力味</a>
                            <li><a href="/BJ/category-102-1.html">拿破仑口味</a>
                            <li><a href="/BJ/category-112-1.html">鲜果口味</a>
                            <li><a href="/BJ/category-113-1.html">冰淇淋味</a>
                            <li><a href="/BJ/category-114-1.html">奶油口味</a>
                            <li class="TN_noneBUT"><a href="/BJ/category-124-1.html">其他</a>
            ...
            <li>
                <!----甜品馆---->
                <dt><a href="/BJ/category-1000-1.html"><img alt="甜品馆"
                                                            src="${pageContext.request.contextPath}/static/picture/tntoplist7.jpg"></a>
                </dt>
                <dt class="TN_drop-down">
                    <div class="TN_drop-down_menuBG" style="height: 0px"></div>
                    <!--div class="TN_drop-down_menu">
                <p><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_top_little_03.png" width="8" height="4" /></p>
                <ul class="L">
            ...
            <li class="TN_logo" style=" margin: 0 10px;">
                <img alt="诺心蛋糕" src="${pageContext.request.contextPath}/static/picture/tntoplistlogo.jpg" width="271"
                     height="52"/>
            </li>

            <li style="margin-left: 0px; ">
                <!----我的诺心---->
                <dt><a href="/shop/member_user.php"><img alt="我的诺心"
                                                         src="${pageContext.request.contextPath}/static/picture/tntoplist3.jpg"></a>
                </dt>
            ...
            <li>
                <!----企业专区---->
                <dt style="cursor: pointer"><img alt="企业专区"
                                                 src="${pageContext.request.contextPath}/static/picture/tntoplist4.jpg">
                </dt>
            ...
            <li>
                <!---关于诺心-->
                <dt style="cursor: pointer"><img alt="关于诺心"
                                                 src="${pageContext.request.contextPath}/static/picture/tntoplist8.jpg">
                </dt>
                <dd style="cursor: pointer"></dd>
                <dt class="TN_drop-down">
                    ...
                    <div class="TN_drop-down_menu">
                        <p><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_top_little_03.png"
                                width="8" height="4"/></p>
                        <ul class="L">
                            <li><a href="/BJ/siteNews.html">诺心新闻</a></li>
    ...
    <div class="TN_list">
        <ul>
            ...
            <li class="TN_done">
                ...
                <a id="shop_cart" class="cursorPointer" onclick="self.location='/shop/cart.php'">购物车<span
                        id="js_cart_goods_number" class="TNgg">0</span>件</a><span class="TN_st">|</span>
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2" class="newbgbox"><!------内容背景第二层--------------->
        <div class="TN_BigBoxBG "><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div class="settle-menu">
                <div class="cart-step3">
                    <div class="buy-plan"></div>
                    <ul>
                        <li><em class="s-color">我的购物车</em></li>
                        <li style="width:520px;"><em class="s-color">填写核对订单信息</em></li>
                        <li>成功提交订单</li>
                    </ul>
                </div>
                <div class="sub-order">
                    <div class="wd935">
                        <div class="wd935-01">
                            ...
                            <div class="success-info">
                                <div class="info-01">订单<span class="order-num">20181114SHWZ218849</span>已提交，我们会尽快安排配送中心发货。
                                </div>
                                <div class="info-02">

                                    您需要<!--在收货后向送货员--> 支付￥<span class="price-color">174.40</span>元，谢谢您的配合支持。
                                </div>
                                <div class="countdown_wrap" id="countdownWrap">
                                    <h4>支付剩余时间<span id="countdownStr">00 : 00</span></h4>
                                </div>
                                <div class="info-03" id="orderStatus">
                                    <span>请点击支付宝按钮完成支付</span>
                                    <span>
									<a target="_blank" id="payment_id" onclick="Payment.pay(this);" value="alipay"
                                       class="bank-btn_alipay"
                                       style="background: url('${pageContext.request.contextPath}/static/images/58ea8fb95d0e1.jpg');width: 154px;"></a>
								</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wd935-03">
                            <div class="state">
                                现在，您可以：查看
                                <a href="/shop/member_order_detail.php?order_id=20181114SHWZ218849">订单状态>></a>
                                <a href="https://www.lecake.com">继续购物</a>
                            </div>
                            <div class="state">当日配送订单，不可修改。非当日配送订单，需提前一天的中午12:00之前，可对部分订单内容进行修改 <a
                                    href="/shop/member_order_detail.php?order_id=20181114SHWZ218849">订单详情>></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" name="bill_no" value="20181114SHWZ218849"/>
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/site.js"></script>
            ...
            <script src="${pageContext.request.contextPath}/static/js/jscal2.js"></script>
            <script src="${pageContext.request.contextPath}/static/js/cn.js"></script>
            <script type="text/javascript">
                var deliver = {
                    //收货人信息
                    deliverID: "",
                ...
                var bill = {
                    total: 0,
                    freight: 0,
                    billdelay: 0   //addby LFL 2013-09-02 是否延迟标识
                };

                function submit_goods(goodsflg) {
                    var userName = $("#userName" + goodsflg).val();
                    var address = $("#address" + goodsflg).val();
                    var mobile = $("#mobile" + goodsflg).val();
                    var send_date = $("#send_date" + goodsflg).val();
                    var provincename = $("#provinceid" + goodsflg).find("option:selected").text();
                    var cityname = $("#cityid" + goodsflg).find("option:selected").text();
                    var countyname = $("#countyid" + goodsflg).find("option:selected").text();
                    var townname = $("#townid" + goodsflg).find("option:selected").text();
                    var countyid = $("#countyid" + goodsflg).val();
                    var townid = $("#townid" + goodsflg).val();
                    var send_start_time = $("#send_start_time" + goodsflg).find("option:selected").text();
                    var send_end_time = $("#send_end_time" + goodsflg).find("option:selected").text();
                    if (userName == '' || address == '' || mobile == '' || countyid == '' || townid == '') {
                        comm_alert("请填写完整的收货人信息！");
                        return false;
                    }
                    ...
                    var goodsarr = {
                        'flg': goodsflg,
                        'bill_no': '20181114SHWZ218849',
                        'userName': userName,
                        'mobile': mobile,
                        'address': provincename + cityname + countyname + townname + address,
                        'send_date': send_date + ' ' + send_start_time + '-' + send_end_time
                    };
                    xajax_do_req_bill(goodsarr, 20);
                    //alert(JSON.stringify(goodsarr));
                }

                function isret(state, id) {
                    if (state == 1) {
                        comm_alert("收货人信息保存成功！<br/>等待客服确认。");
                        $("#is_goods" + id).hide();
                    } else {
                        comm_alert("收货人信息已提交！<br/>等待客服确认。");
                    }
                }
            </script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/survey.js"></script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/region.js"></script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/payquick.js"></script>
            <script type='text/javascript' src='${pageContext.request.contextPath}/static/js/global.js'></script>
            <!---------footer star---------------------------------->
        ...
        <div class="TN_footer hide">
            <div class="TN_footercen">
                ...
                <div class="TN_Fone">
                    <span class="TN_but_logo"><img
                            src="${pageContext.request.contextPath}/static/picture/tn_but_logo.png" width="258"
                            height="55"/></span>
                    <span class="TN_butL_Byu">新鲜配送上门</span>
                    <!--span class="TN_but_flower"><img src="${pageContext.request.contextPath}/static/picture/tn_footflower_14.jpg" width="22" height="24" /></span--->
                    <p style="margin-right: 5px">
                    <p>
                        <a href="/SH/index.html" class="L" onclick="return city.set_city('2','上海市','SH');">上海</a>
                        <span class="TN_st">|</span> <a href="/BJ/index.html" class="L"
                                                        onclick="return city.set_city('287','北京市','BJ');">北京</a>
                        <span class="TN_st">|</span> <a href="/GZ/index.html" class="L"
                                                        onclick="return city.set_city('420','广州市','GZ');">广州</a>
                        <span class="TN_st">|</span> <a href="/NJ/index.html" class="L"
                                                        onclick="return city.set_city('355','南京市','NJ');">南京</a>
                        <span class="TN_st">|</span> <a href="/CD/index.html" class="L"
                                                        onclick="return city.set_city('449','成都市','CD');">成都</a>
                        <span class="TN_st">|</span> <a href="/CQ/index.html" class="L"
                                                        onclick="return city.set_city('499','重庆市','CQ');">重庆</a>
                        <span class="TN_st">|</span> <a href="/SN/index.html" class="L"
                                                        onclick="return city.set_city('386','深圳市','SN');">深圳</a>
                        <span class="TN_st">|</span> <a href="/HZ/index.html" class="L"
                                                        onclick="return city.set_city('83','杭州市','HZ');">杭州</a>
                        <span class="TN_st">|</span> <a href="/SZ/index.html" class="L"
                                                        onclick="return city.set_city('228','苏州市','SZ');">苏州</a>
                        <span class="TN_st">|</span> <a href="/TJ/index.html" class="L"
                                                        onclick="return city.set_city('334','天津市','TJ');">天津</a>
                        <span class="TN_st">|</span> <a href="/NB/index.html" class="L"
                                                        onclick="return city.set_city('356','宁波市','NB');">宁波</a>
                        <span class="TN_st">|</span> <a href="/WX/index.html" class="L"
                                                        onclick="return city.set_city('261','无锡市','WX');">无锡</a>
                        <span class="TN_st">|</span> <a href="/SX/index.html" class="L"
                                                        onclick="return city.set_city('446','绍兴市','SX');">绍兴</a>
                        <span class="TN_st">|</span> <a href="/JX/index.html" class="L"
                                                        onclick="return city.set_city('447','嘉兴市','JX');">嘉兴</a>
                    </p>

                    </p>
                </div>
                <ul>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_l.png" width="52"
                             height="52"/>&nbsp;<b>全年无休</b></li>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_e.png" width="52"
                             height="52"/>&nbsp;<b>安全配送</b></li>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_c.png" width="52"
                             height="52"/>&nbsp;<b>品质保证</b></li>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_a.png" width="52"
                             height="52"/>&nbsp;<b>上乘食材</b></li>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_k.png" width="52"
                             height="52"/>&nbsp;<b>专业客服</b></li>
                    <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_e.png" width="52"
                             height="52"/>&nbsp;<b>企业采购</b></li>
                </ul>
                <p class="TN_Ftow">
                    <!--
                    ...
                    <SCRIPT LANGUAGE="JavaScript">
                        document.writeln("<a href='https://www.sgs.gov.cn/lz/licenseLink.do?method=licenceView&entyId=1u2xwmwzpxrk6u2rvor2928au92degmyr8rxc2ylqre60wm'><img src='${pageContext.request.contextPath}/static/picture/gsicon.gif' style='margin-top:-4px' border=0></a>")
                    </SCRIPT>
                </p>
                <p class="TN_Fstree L">
                    <a href="http://www.miibeian.gov.cn/" target="_blank">沪ICP备10211730</a> |
                    <span><a href="//rescdn.lapetit.cn/shop/lecake/theme/xth2/images/index/business_certificate3.jpg"
                             style="margin: 0" target="_blank">社会信用代码：913100005648062293</a></span> |
                    <span><a href="//rescdn.lapetit.cn/shop/lecake/theme/xth2/images/index/business_certificate1.jpg"
                             style="margin: 0" target="_blank">食品经营许可证</a></span> |
                    <span><a href="//rescdn.lapetit.cn/shop/lecake/theme/xth2/images/index/business_certificate2.jpg"
                             style="margin: 0" target="_blank">诺心上海生产许可证</a></span> |
        ...
        <div id="comm_alert" class="comm_alert hide comm_layer">
            <table>
                ...
                <tr>
                    ...
                    <td class="mid_c">
                        <div class="pb-b-box">
                            <a title="关闭" class="close-popup" onclick="come_bcak_href();" id="aClose_dialog"
                            ...
                            <div class="linkbox" id="linkbox">
                                <a onclick="come_bcak_href();" class="link-button" id="btnClose_dialog"
        ...
        <div id="comm_confirm" class="comm_alert comm_layer hide">
            <table>
                ...
                <tr>
                    ...
                    <td class="mid_c">
                        <div class="pb-b-box">
                            <a title="关闭" class="close-popup" onclick="comm_box.confirm_close(0);" id="aClose_dialog"
                               href="javascript:void(0)">关闭</a>
                            <div class="pb-titleg">
                                <strong>提示信息</strong>
                            </div>
                            ...
                            <div class="linkbox">
                                <a onclick="comm_box.confirm_close(1);" class="link-button-green"
                                   href="javascript:void(0)">
                                    <span>确定</span>
                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="layer hide" id="layer">
            <div class="layer-main" id="layer_main">
                ...
                <div class="layer-footer" id="layer_footer"
                     style="background:none repeat scroll 0 0 white;border-top:1px solid white;"></div>
            </div>
        </div>
        ...
        <div class="online_service hide">
            <a class="service_btn" href="javascript:void(0)" id="online_service">
                <img class="icon" src="${pageContext.request.contextPath}/static/picture/ico_service.png" alt=""/>
                <img class="pop_img service_help"
                     src="${pageContext.request.contextPath}/static/picture/service_help.png" alt=""/>
            </a>
            <a class="service_btn" href="javascript:void(0)">
                <img class="icon" src="${pageContext.request.contextPath}/static/picture/ico_wechat.png" alt=""/>
                <img class="pop_img wechat_qr_code"
                     src="${pageContext.request.contextPath}/static/picture/wechat_qr_code.png" alt=""/>
            </a>
        </div>
        <script>
            ...
            ud({
                ...
                "customer": {
                    "nonce": "E9ITYMZbtKqU8aRi",
                    "timestamp": 1542167586947,
                    "web_token": "7531703",
                    "signature": "A5A6FC60A966C72A6E906DB197D20F654B1EFBF2",
                    "c_cn_pcustID": "7531703",
                    "c_cn_clickID": "KyiQ6fsx6Wkp",
                    "c_cn_zzuID": "KyHToqMRK5fq"
                }
            });
        </script>
                    ...
                    <div id="cust_main">
                        ...
                        <div id="span_open_login">
                            ...
                            <p class="p_item p_btn">
                                <button class="eb_btn login_btn" type="button" onclick="customer.login(2);"><h3>登 录</h3>
                                </button>&nbsp;&nbsp;
                        ...
                        <div id="span_open_reg" class="hide">
                            ...
                            <p class="p_item">
                                ...
                                <input type="text" autocomplete="off" maxlength="11" name="userName" id="reg_userName"
                                       class="txt"/>
                            ...
                            <p class="p_item">
                                <label class="itemtitle">验证码：</label>
                                <input type="text" maxlength="4" style="" name="yzm" id="reg_yzm" autocomplete="off"
                                       class="txt"/>
                            ...
                            <p class="p_item">
                                ...
                                <input type="text" id="reg_m_vcode" class="reg_vcode" name="mobile_vcode" class="txt"
                                       maxlength="6">
                            ...
                            <p class="p_item p_btn">
                                <button class="eb_btn reg_btn" type="button" onclick="customer.register(2,2);"><h3>
                                    提交注册信息</h3></button>
                                <br><br>
            ...
            <table>
                ...
                <tr>
                    <th>
                        ...
                        <a class="fr" href="javascript: void(0);"
                           onclick="$('#region_pop').hide();$('#ap_provincebox_pop').hide();">[关闭]</a>
                    </th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td style="height: 50px;line-height: 50px;border-bottom: 0px;">
                                ...
                                <ul class="title">
                                    ...
                                    <li class="fr">
                                        <a href="javascript:void(0);" class="close"
                                           onclick="$('#ap_provincebox_pop').hide();">[关闭]</a>
                                    </li>
                                </ul>
                                <div class="clear"></div>
                        ...
                        &nbsp;&nbsp;<img class="hand" src="${pageContext.request.contextPath}/static/picture/btn_ok.jpg"
                                         onclick="pop_add_goods_to_cart();"/>
                    </td>
                </tr>
                <tr>
        ...
        <div id="add_cart_success" class="comm_pop hide" style="margin-top:150px;">
            <table>
                ...
                <tr>
                    ...
                    <th class="tar"><a id="CloseLogin" href="javascript:void(0);"
                                       onclick="$('#add_cart_success').hide();">[关闭]</a></th>
                </tr>
                </thead>
        ...
        <div id="city_login_main" class="city_comm_pop hide">
            <div class="city_eb_div">
                <div class="lecake_city_logo">
                    <img src="${pageContext.request.contextPath}/static/picture/b_logo.png">
                </div>
...
<div id="listHtml"></div>
<input type="hidden" id="orderTime" value="1542167409">
<input type="hidden" id="nowTime" value="1542167586000">
<script>
    //支付倒计时
    $(function () {
        var dom = $('#countdownStr'),
            time = parseInt($('#orderTime').val()) * 1000,
            now = parseInt($('#nowTime').val());
        if ($('#payment_id').length || $('#goWxPay').length) {
            Countdown(dom, now, time, function () {
                $('#orderStatus').text('交易关闭');
            });
        }
    });

    function getTime(time, m) {
        var t = m ? time / 1000 / 60 % 60 : time / 1000 % 60;
        t = Math.floor(t).toString();
        t = t.length === 1 ? '0' + t : t;
        return t;
    }

    function Countdown(dom, now, time, fn) {
        var endTime = 20 * 60 * 1000 + time,
            lastTime = endTime - now;
        if (lastTime > 0) {
            dom.text(getTime(lastTime, true) + ' : ' + getTime(lastTime));
    ...
    var Payment = {
        pay: function (obj) {
            ...
            params['bill_no'] = $('input[name=bill_no]').val();		    //支付订单号
            params['payment_id'] = $('#payment_id').attr('value');		//支付类型
            xajax_do_req_bill(params, 2);
        }
    }
...
<script type="text/javascript">
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-10311370-6']);
...
<!--add　by Jerry 2013-03-06 phpstat-->
<script type="text/javascript">
    bill.changSendTime1 = function (time_flg) {
        var send_start_time = $("#send_start_time1").val();
        var send_end_time = $("#send_end_time1").val();
        if (send_start_time < send_end_time)
            return false;
        if (time_flg == 1) {
            if (send_start_time.substring(2) == "3000") {
                $("#send_end_time1").val(parseInt(send_start_time) + 7000);
            } else {
                var temp = parseInt(send_start_time.substring(0, 2));
                if ((temp >= 10 && temp < 13) || (temp >= 16 && temp < 18)) {
                    $("#send_end_time1").val(parseInt(send_start_time) + 10000);
                } else {
                    $("#send_end_time1").val(parseInt(send_start_time) + 3000);
                }
            }

        } else {
            if (parseInt(send_end_time.substring(2)) == 3000) {
                $("#send_start_time1").val(parseInt(send_end_time) - 3000);
            } else {
                var temp = parseInt(send_end_time.substring(0, 2));
                if ((temp >= 10 && temp <= 13) || (temp > 16 && temp <= 18)) {
                    $("#send_start_time1").val(parseInt(send_end_time) - 10000);
                }
                else {
                    $("#send_start_time1").val(parseInt(send_end_time) - 7000);
                }
            }

        }
    }
    bill.changSendTime2 = function (time_flg) {
        var send_start_time = $("#send_start_time2").val();
        var send_end_time = $("#send_end_time2").val();
        if (send_start_time < send_end_time)
            return false;
        if (time_flg == 1) {
            if (send_start_time.substring(2) == "3000") {
                $("#send_end_time2").val(parseInt(send_start_time) + 7000);
            } else {
                var temp = parseInt(send_start_time.substring(0, 2));
                if ((temp >= 10 && temp < 13) || (temp >= 16 && temp < 18)) {
                    $("#send_end_time2").val(parseInt(send_start_time) + 10000);
                } else {
                    $("#send_end_time2").val(parseInt(send_start_time) + 3000);
                }
            }

        } else {
            if (parseInt(send_end_time.substring(2)) == 3000) {
                $("#send_start_time2").val(parseInt(send_end_time) - 3000);
            } else {
                var temp = parseInt(send_end_time.substring(0, 2));
                if ((temp >= 10 && temp <= 13) || (temp > 16 && temp <= 18)) {
                    $("#send_start_time2").val(parseInt(send_end_time) - 10000);
                }
                else {
                    $("#send_start_time2").val(parseInt(send_end_time) - 7000);
                }
            }
    ...
    var deliver2 = {
        H: "<option value=\"\" label=\"请选择...\">请选择...</option>",
        temp: {},
        edit_deliverid: "",

        //更换省份，同时得到市区信息
        province_change: function (flg) {
            var temp = this.temp;
            temp.provinceID = $("#provinceid" + flg).val();
            $("#townid" + flg).html(this.H);
            $("#countyid" + flg).html(this.H);
            if (temp.provinceID == "") {
                $("#cityid" + flg).html(this.H);
                $("#render").text("");
            } else {
                temp.provinceName = $("#provinceid" + flg).find("option:selected").text();
                temp.province = region_obj[temp.provinceID];
                var listHtml = "";
                if (temp.province.c) {
                    $.each(temp.province.c, function (k, v) {
                        if (!customer.cityID || k == customer.cityID)
                            listHtml += "<option value=\"" + k + "\" label=\"" + v.n + "\">" + v.n + "</option>";
                    });
                }
                $("#cityid" + flg).html(listHtml);
                $("#render").text(temp.provinceName);
            }
            temp.cityID = "";
            temp.countyID = "";
            temp.townid = "";
        ...
        //更换市区，同时得到地区信息
        city_change: function (flg) {
            var temp = this.temp;
            temp.cityID = $("#cityid" + flg).val();
            $("#townid" + flg).html(this.H);
            if (temp.cityID == "") {
                $("#countyid" + flg).html(this.H);
                $("#render").text(temp.provinceName);
            } else {
                temp.cityName = $("#cityid" + flg).find("option:selected").text();
                temp.city = temp.province.c[temp.cityID];
                var listHtml = this.H;
                if (temp.city.c) {
                    $.each(temp.city.c, function (k, v) {
                        listHtml += "<option value=\"" + k + "\" label=\"" + v.n + "\">" + v.n + "</option>";
                    });
                }
                $("#countyid" + flg).html(listHtml);
                $("#render").text(temp.provinceName + " " + temp.cityName);
                $("#add_4").val(temp.city.a);
            }
            temp.countyID = "";
            temp.townid = "";
        },
        ...
        //更换地区
        county_change: function (flg) {
            var temp = this.temp;
            temp.countyID = $("#countyid" + flg).val();
            if (temp.countyID == "") {
                $("#townid" + flg).html(this.H);
                $("#render").text(temp.provinceName + " " + temp.cityName);
            } else {
                temp.countyName = $("#countyid" + flg).find("option:selected").text();
                temp.county = temp.city.c[temp.countyID];
                var listHtml = this.H;
                if (temp.county.c) {
                    $.each(temp.county.c, function (k, v) {
                        listHtml += "<option value=\"" + k + "\" label=\"" + v + "\">" + v + "</option>";
                    });
                }
                $("#townid" + flg).html(listHtml);
                $("#render").text(temp.provinceName + " " + temp.cityName + " " + temp.countyName);
            }
            temp.townid = "";
        },

        //更新镇
        town_change: function (flg) {
            var temp = this.temp;
            temp.townID = $("#townid" + flg).val();
            if (temp.townID == "") {
                $("#render").text(temp.provinceName + " " + temp.cityName + " " + temp.countyName);
            } else {
                temp.townName = $("#townid" + flg).find("option:selected").text();
                $("#render").text(temp.provinceName + " " + temp.cityName + " " + temp.countyName + " " + temp.townName);
            }
        }
    }
</script>
