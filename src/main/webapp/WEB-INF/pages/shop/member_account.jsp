...
<head>
    ...
    <title>我的帐户-诺心LECAKE</title>
    <meta name="Keywords" content="我的帐户，诺心线上蛋糕,蛋糕网购,蛋糕预订,正宗欧洲精品蛋糕,生日蛋糕,商务蛋糕,婚庆蛋糕,蛋糕货到付款" />
    <meta name="Description" content="我的帐户。诺心蛋糕精选进口新鲜食材，提供健康、高品质的蛋糕产品，线上销售、预订生日蛋糕、巧克力蛋糕、芝士蛋糕、慕斯蛋糕、商务蛋糕、婚庆蛋糕，支持蛋糕货到付款。诺心LECAKE蛋糕官网，臻品蛋糕，美味直送到家！" />
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyJH4XVKzD6g"};</script>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        xajax.config.requestURI = "/shop/member_account.html";
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
                        ...
                        <div class="menu">
                            <div class="box">
                                ...
                                <dl>
                                    <dt>会员中心</dt>
                                    <dd >
                                        <a href="/customer/index.html?operFlg=1">首页</a>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>交易记录</dt>
                        ...
                        <div class="main">
                            ...
                            <div class="member_box">
                                <table>
                                    <thead>
                                    <tr>
                                        <td style="text-align:center; width:10px;">订单号</td>
                                        <td style="text-align:center; width:10px;">商品名称</td>
                                        <td style="text-align:center; width:10px;">订单积分</td>
                                    ...
                                    <thead>
                                    <tr>
                                        <td style="text-align:center; width:10px;">${order.id}</td>
                                        <td style="text-align:center; width:10px;">${order.orderitem.product.name}</td>
                                        <td style="text-align:center; width:10px;">${order.integral}</td>
                                        <%--<td style="text-align:center; width:25%;"></td>--%>
                                    </tr>
                                    </thead>
                                    </c:forEach>
        ...
        <script>
            ...
            ud({
                ...
                },"customer":{"nonce":"ZX62VfT37nPWl1y4","timestamp":1541755674308,"web_token":"7527158","signature":"4F811D7CDBE3D04097A965512017B17D9698C5E1","c_cn_pcustID":"7527158","c_cn_clickID":"KyJH4XVKzD6g","c_cn_zzuID":"KyHRa3ClJ3wO"}    });
        </script>
