...
<head>
    ...
    <title>千层之约  层意十足-诺心LECAKE</title>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyXdhrZoZsGZ"};</script>
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
                ...
                <p>
                    <style type="text/css">
                        ...
                        .swiper-container-rtl .swiper-button-prev {
                            background-image: url('<%=request.getContextPath()%>/static/images/right_btn.png') !important;
                            /*right: 128px !important;*/
                        }

                        .swiper-button-prev,
                        .swiper-container-rtl .swiper-button-next {
                            background-image: url('<%=request.getContextPath()%>/static/images/left_btn2.png') !important;
                        ...
                        .bg1 {
                            height: 724px;
                            background: url('<%=request.getContextPath()%>/static/images/bg_01.jpg') center no-repeat;
                        }
                        ...
                        .bg2 {
                            height: 348px;
                            margin-top: -1px;
                            background: url('<%=request.getContextPath()%>/static/images/bg_02.jpg') center no-repeat;
                        }
                        ...
                        .bg3 {
                            height: 864px;
                            margin-top: -1px;
                            background: url('<%=request.getContextPath()%>/static/images/bg_03.jpg') center no-repeat;
                        }

                        .hualanbg3 {
                            height: 840px;
                            margin-top: -1px;
                            background: url('<%=request.getContextPath()%>/static/images/hualan-bg4.jpg') center no-repeat !important;
                        }
                        ...
                        .bg4 {
                            height: 774px;
                            background: url('<%=request.getContextPath()%>/static/images/qcbg_4.jpg') center no-repeat;
                            margin-top: -1px;
                        }
                        ...
                        .bg5 {
                            height: 930px;
                            background: #c52230 url('<%=request.getContextPath()%>/static/images/bg_05.jpg') center no-repeat;
                            overflow: hidden;
                            margin-top: -20px;
                            margin: auto;
                            max-width: 1920px;
                        ...
                        .bg6 {
                            height: 757px;
                            background: url('<%=request.getContextPath()%>/static/images/bg_06.jpg') center no-repeat;
                            margin-top: -117px;
                        }
                        ...
                        .bg_img1 {
                            height: 571px;
                            background: url('<%=request.getContextPath()%>/static/images/ls_img1.jpg') center no-repeat;
                        }
                        ...
                        .bg_img2 {
                            height: 279px;
                            background: url('<%=request.getContextPath()%>/static/images/ls_img2.jpg') center no-repeat;
                        }
                        ...
                        .bg_img3 {
                            height: 538px;
                            background: url('<%=request.getContextPath()%>/static/images/ls_img3.jpg') center no-repeat;
                        }
                        ...
                        .bg_img4 {
                            height: 409px;
                            background: url('<%=request.getContextPath()%>/static/images/ls_img4.jpg') center no-repeat;
                        }
                        ...
                        .bg_color p {
                            color: #edd19f !important;
                        }

                        .bg_img6 {
                            height: 619px;
                            background: #9d0d24 url('<%=request.getContextPath()%>/static/images/ls_img5.jpg') center no-repeat;
                            margin: auto;
                            max-width: 1920px;
                        }
                        ...
                        .bg_img6 .bttom_text p {
                            line-height: 26px;
                            color: #edd19f;
                        }

                        .bg_img6 .bttom_text h4 {
                            color: #edd19f;
                        }
                        ...
                        .btn_baer .swiper-container {
                            width: 820px !important;
                            height: 479px !important;
                            margin: 0 auto !important;
                        }

                        .btn_baer .swiper-wrapper {
                            height: 334px !important;
                        }

                        .btn_baer .swiper-container-horizontal>.swiper-pagination-bullets,
                        ...
                        .btn_baer .swiper-button-next,
                        .swiper-button-prev {
                            top: 38%;
                            right: 28px !important;
                        }

                        .btn_baer .swiper-button-prev,
                        .swiper-container-rtl .swiper-button-next {
                            top: 38%;
                            left: 28px !important;
                        }

                        .btn_baer .swiper-pagination-bullet {
                            width: 10px !important;
                            height: 10px !important;
                            display: inline-block;
                            opacity: 1.2 !important;
                            background: none !important;
                            border: 2px solid #edd19f !important;
                        }

                        .btn_baer .swiper-pagination-bullet-active {
                            background: #edd19f !important;
                        }
                        ...
                        .btn_baer1 .swiper-button-next,
                        .swiper-container-rtl .swiper-button-prev {
                            right: 128px !important;
                        }

                        .btn_baer1 .swiper-button-prev,
                        .swiper-container-rtl .swiper-button-next {
                            left: 128px !important;
                        }

                        .btn_baer1 .swiper-wrapper {
                            height: 685px;
                        }
                    </style>
                </p>
                ...
                <!--华东，华西，华北-->
                <div class="content1  childrenday_section_toggle ">
                    <div class="bg_img1  bg ">
                        <a href="/shop/goods-108673.html">&nbsp;</a>
                    </div>
                    <div class="bg_img2 bg">
                        <a href="javascript:app_js.buyItem(108673,1,false);">&nbsp;</a>
                    </div>
                    <div class="bg_img3 bg">
                        <a href="/shop/goods-108405.html" class="left_img">&nbsp;</a>
                        <a href="javascript:app_js.buyItem(108405,1,false);" class="right_btn">&nbsp;</a>
                    </div>
                    <div class="bg_img4 bg" style="">
                        <a href="/shop/goods-108406.html" class="double11 right_btn">&nbsp;</a>
                        <a href="/shop/goods-108622.html" class="double11 right_btn hide">&nbsp;</a>
                        <a href="javascript:app_js.buyItem(108406,1,false);" class="double11 left_img">&nbsp;</a>
                        <a href="javascript:app_js.buyItem(108622,1,false);" class="double11 hide left_img">&nbsp;</a>
                    </div>
                    <div class="bg bg_img5">
                        <div class="title_txt title" style="background: none;">
                            <div class="hd bg_color">
                                <p class="text_top">「薄韧饼皮&middot;讲究」</p>
                                <p class="text_btom">无数次的配比调试，弹韧度、湿润度贴合唇齿的喜好。</p>
                            </div>
                            <div class="hd bg_color" style="display: none;">
                                <p class="text_top">「清润奶油&middot;绝密」</p>
                                <p class="text_btom">多款进口奶油特别调制，轻柔口感类似云朵、清风和爱情。</p>
                            </div>
                            <div class="hd bg_color" style="display: none;">
                                <p class="text_top">「实力颜值&middot;别致」</p>
                                <p class="text_btom">别致精巧的颜值与美味并存，层层诠释时光、心情至美。</p>
                            </div>
                        </div>
                        <!-- Swiper -->
                        <div class="btn_baer">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_1.png" alt="" style="width: 820px;height: 344px;" /></div>
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_2.png" alt="" style="width: 820px;height: 344px;" /></div>
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_3.png" alt="" style="width: 820px;height: 344px;" /></div>
                                </div>
                                <!-- Add Pagination -->
                    ...
                    <div class="bg_img6 bg">
                        <div class="bttom_text">
                            <h4>活动规则</h4>
                            <p>活动时间：2018年11月2日至2018年11月29日</p>
                            <p>配送时间：2018年11月6日至2018年11月30日</p>
                            <p>配送区域：华东、华西、华北诺心可配送区域，具体配送范围及收费标准以下单信息为准</p>
                            <h4 style="margin-top: 8px;">参与规则</h4>
                            <p>1. 活动期间，购买指定款千层蛋糕享8折优惠。</p>
                            <p>2. 适用商品：草莓千层蛋糕、原味千层蛋糕、 栗子千层蛋糕。</p>
                            <p>3. 本活动仅限线上用户参与，不与其他优惠同享（如优惠券、储值卡、蛋糕卡、银行优惠等）。</p>
                        </div>
                    </div>
                </div>
                <!--华南地区-->
                <div class="content childrenday_section_toggle  hide">
                    <div class="bg1 bg"><img src="<%=request.getContextPath()%>/static/picture/bg12_img.gif" alt="" />
                        <a href="/shop/goods-108622.html">&nbsp;</a>
                    </div>
                    <div class="bg2 bg">
                        <a href="javascript:app_js.buyItem(108622,1,false);">&nbsp;</a>
                    </div>
                    <div class=" bg hualanbg3" style="z-index: 1;">
                        <a href="/shop/goods-108405.html" class="left_img">&nbsp;</a>
                        <a href="javascript:app_js.buyItem(108405,1,false);" class="right_btn">&nbsp;</a>
                    </div>
                    <div class="bg5 hualan_bannger bg" style="top: 117px;">
                        <div class="title_txt title1" style="height: auto !important;">
                            <div class="hd ">
                                <p class="text_top">「薄韧饼皮&middot;讲究」</p>
                                <p class="text_btom">无数次的配比调试，弹韧度、湿润度贴合唇齿的喜好。</p>
                            </div>
                        ...
                        <div class="btn_baer1">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_img1.jpg" alt="" /></div>
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_img2.jpg" alt="" /></div>
                                    <div class="swiper-slide"><img src="<%=request.getContextPath()%>/static/picture/banner_img3.jpg" alt="" /></div>
                                </div>
                                <!-- Add Pagination -->
                                <div class="swiper-pagination">&nbsp;</div>
                                <!-- Add Arrows -->
                    ...
                    <div class="bg6 bg">
                        <div class="bttom_text">
                            <h4>活动规则</h4>
                            <p>活动时间：2018年10月26日至2018年11月29日</p>
                            <p>配送时间：2018年11月6日至2018年11月30日</p>
                            <p>配送区域：诺心华南可配送区域，具体配送范围及收费标准以下单信息为准。</p>
                            <h4 style="margin-top: 42px;">参与规则</h4>
                            <p>1. 活动期间，购买指定款千层蛋糕享8折优惠。</p>
                            <p>2. 适用商品：栗子千层蛋糕、原味千层蛋糕。</p>
                            <p>3. 本活动仅限线上用户参与，不与其他优惠同享（如优惠券、储值卡、蛋糕卡、银行优惠等）。</p>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    $(function() {
                        (function() {
                            var cityId = get_COOKIE_INFO('CITY_ID') || '',

                                cityIdArr = cityId.split('_');
                            if(cityIdArr.length) {
                                cityId = cityIdArr[1];
                            } else {
                                cityId = 2;
                            }
                            if($.inArray(parseInt(cityId), [2, 355, 83, 228, 356, 261, 446, 447, 449, 499, 287, 334]) === -1) {

                                $('.childrenday_section_toggle').toggleClass('hide');
                            }

                            if($.inArray(parseInt(cityId), [449, 499]) === -1) {
                                $('.double11').toggleClass('hide');
                            }
                        ...
                        var swiper = new Swiper('.swiper-container', {
                            ...
                            on: {
                                slideChangeTransitionEnd: function() {
                                    ...
                                    console.log(index)
                                    $('.title_txt').children('.hd').eq(index).show().siblings('.hd').hide();

                                    $('.title1').children('.hd').eq(index).show().siblings('.hd').hide();
