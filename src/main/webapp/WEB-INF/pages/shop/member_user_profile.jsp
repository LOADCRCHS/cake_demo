...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyJI7.V66JWa"};</script>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        xajax.config.requestURI = "/shop/member_user.php";
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/css/styles.css" type="text/css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/index.css"/>
    <script language="JavaScript" src="<%=request.getContextPath()%>/static/js/commoncheck.js" type="text/javascript"></script>
    <style>
        .layer{left:0;top:300px;position:absolute;}
        #layer_main{width:350px;}
        .msg_color{color:red;}
    </style>
    ...
    <script type="text/javascript">
        ...
        function checkForm(theform) {
            var _submitForm = function() {
                $(":submit", theform).attr('disabled', true).val('正在提交，请稍等..');
                $(theform).ajaxSubmit({
                    "dataType": "json",
                    "success": function(json) {
                        $(":submit", theform).attr('disabled', false).val('提交资料');
                        if (json.status < 1) {
                            alert(json.msg);
                            if (json.data.field) {
                                $(':input[name^="'+ json.data.field +'"]', theform).eq(0).focus();
                            }
                            return;
                        }
            ...
            xPopup.create({
                "message": "谢谢亲的填写<br />友情提醒，填写星座之后不能修改喔，这样做只为生日时送上真挚的祝福",
                "yes": {
                    "name": "确认",
...
<div class="TN_topheader hide">
    ...
    <div class="TN_menu">
        <ul>
            ...
            <li>
                <!---蛋糕馆--->
                <dt><a href="/BJ/category-0-1.html"><img alt="蛋糕馆" src="<%=request.getContextPath()%>/static/picture/tntoplist2.jpg"></a></dt>
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container">
                <div class="member_container" style="text-align:left;margin:0px auto;">
                    ...
                    <div class="member">
                        ...
                        <div class="menu">
                            <div class="box">
                                ...
                                <dl>
                                    <dt>会员中心</dt>
                                    <dd >
                                        <a href="/shop/member_user.php?operFlg=1">首页</a>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>交易记录</dt>
                                    <dd >
                                        <a href="/shop/member_order.php?orderflg=1">我的订单</a>
                                    </dd>
                                    <!--
                                    <dd {if $classFlg=='tuanOrder'}class="current"{/if}>
                                        <a href="/shop/tuan_order.php">团购订单</a>
                                    </dd>
                                    -->
                                </dl>
                                <dl>
                                    <dt>我的账户</dt>
                                    <dd >
                                        <a href="/shop/member_account.php">积分余额</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_accountHistory.php">积分明细</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_balance.php">账户余额</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_balanceHistory.php">余额明细</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_cake_coupons.php?flg=1">蛋糕卡</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_coupons.php?flg=1">优惠券</a>
                                    </dd>
                                </dl>
                                <!--<dl>
                                    <dt>我的收藏</dt>
                                    <dd >
                                        <a href="/shop/member_favorites.php">商品收藏</a>
                                    </dd>			
                                </dl>-->
                                <dl>
                                    <dt>我的咨询</dt>
                                    <dd >
                                        <a href="/shop/member_consultation.php">商品咨询</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_comments.php">商品评论</a>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>个人设置</dt>
                                    <dd class="current">
                                        <a href="/shop/member_user_profile.php">LE家族</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_editUser.php">修改资料</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_pwd.php">修改密码</a>
                                    </dd>

                                    <dd >
                                        <a href="/shop/member_consignee.php">收货地址</a>
                                    </dd>
                                    <dd >
                                        <a href="/shop/member_invoice.php">发票管理</a>
                                    </dd>
                                    <!--
                                    <dd {if $classFlg=='easybuy'}class="current"{/if}>
                                        <a href='/shop/member_easybuy.php'>轻松购</a>
                                    </dd>
                                    -->
                                </dl>
                                ...
                                <dl>
                                    <dt>其他操作</dt>
                                    <dd>
                                        <a href="javascript:if (confirm('您确定要退出登录吗？')) self.location = '/shop/logout.php';">退出登录</a>
                                    </dd>
                                </dl>
                                <!-- 会员中心菜单 结束 -->
                            </div>
                        ...
                        <div class="main">
                            <h2 class="title">我的LE家族:</h2>
                            <div style="height:10px; clear:both;"></div>
                            <div class="member_correct">

                                <div class="member_bor">
                                    <a href="javascript:void(0)" class="member_le_tab selected">我</a><a href="/shop/member_user_family.php" class="member_le_tab">我爱的人</a>
                                    <div style="height:10px; clear:both;"></div>
                                    <div class="member_le_jf">可用积分：<b>0</b>   </div>
                                    <div style="height:10px; clear:both;"></div>
                                    <form id="userform" method="post" action="/shop/member_user_profile.php?action=submit" onsubmit="return checkForm(this);">
                                        <table width="92%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto; font-size:12px;">
                                            <tr>
                                                <td height="40" width="8%">昵称：</td>
                                                <td><input name="nickname" type="text" class="input" placeholder="给自己设置好听的昵称" size="30" value="" /></td>
                                            </tr>
                                            <tr>
                                                <td height="40">性别：</td>
                                                <td><input name="sex" type="radio" value="女士"  />
                                                    <img src="<%=request.getContextPath()%>/static/picture/girl.jpg" align="absmiddle" />  女士&nbsp;&nbsp;&nbsp;&nbsp;<input name="sex" type="radio" value="男士"   />
                                                    <img src="<%=request.getContextPath()%>/static/picture/man.jpg" align="absmiddle" />  男士</td>
                                            </tr>
                                            <tr>
                                                <td height="45" width="8%">星座：</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td valign="top">品味：</td>
                                                <td valign="top">
                                                    <input name="research[]" type="checkbox" value="芝士"  /> 芝士<br />
                                                    <img src="<%=request.getContextPath()%>/static/picture/mem_le_1.jpg" align="absmiddle" />&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/static/picture/mem_le.jpg" align="absmiddle" />

                                                    <br /><br />
                                                    <input name="research[]" type="checkbox" value="慕斯"  />
                                                    慕斯<br />
                                                    <img src="<%=request.getContextPath()%>/static/picture/mem_le_3.jpg" align="absmiddle" />

                                                    <br /><br />
                                                    <input name="research[]" type="checkbox" value="巧克力"  />
                                                    巧克力<br />
                                                    <img src="<%=request.getContextPath()%>/static/picture/mem_le_4.jpg" align="absmiddle" />
                                                    <br /><br />
                                                    <input name="research[]" type="checkbox" value="拿破仑"  />
                                                    拿破仑<br />
                                                    <img src="<%=request.getContextPath()%>/static/picture/mem_le_5.jpg" align="absmiddle" />&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/static/picture/mem_le_6.jpg" align="absmiddle" />
                                                </td>
                                            </tr>
                                        </table>
                                        <br /><br />
                                        <input type="submit" value="提交资料" class="memLeBtn" />
                                    </form>
                                    <br />
                                    <br />
            ...
            <div id="alert_head" class="hide">
                <div id="head_top">
                    <img class="member_logo" src="<%=request.getContextPath()%>/static/picture/member_logo.gif" style="margin:0 auto;display:block;float:none;" />
                </div>
                <div id="head_center" style="margin-top:10px;">
                    <form id="headForm" name="headForm" enctype="multipart/form-data" action="/shop/uploadHead.php" method="post" target="hidden_frame" style="text-align:center;" >
                        <iframe name="hidden_frame" id="hidden_frame" style="display:none;" ></iframe>
                        <input type="file" name="head_file" id="head_file">
                        <input type="submit" name="send" id="send" value="上传" style="width:38px;height:20px;line-heigh:20px;text-align:center;" >
                    </form>
                </div>
                <div class="err_msg" style="margin-top:5px;text-align:center;">上传图片类型必须是jpg,jpeg,gif,png,bmp</div>
            </div>
        ...
        <script>
            ...
            ud({
                ...
                },"customer":{"nonce":"QuSrRjAMqo6Iqrbl","timestamp":1541755940232,"web_token":"7527158","signature":"6DC5BF0B445C0E16489C417CA7660DCEF6E35C4A","c_cn_pcustID":"7527158","c_cn_clickID":"KyJI7.V66JWa","c_cn_zzuID":"KyHRa3ClJ3wO"}    });
        </script>
...
<script>
    var layer = {
        ...
        close: function() {
            ...
            $(".err_msg").removeClass("msg_color");
        }

    };

    function alertHead(){
        var listHtml = $("#alert_head").html();
        $("#layer_title").text("修改头像");
        $("#layer_content").html(listHtml);
        layer.open();
    }
    ...
    //上传的错误信息
    function uploadError(flg,color){
        if(flg == 1){
            $(".err_msg").html('头像上传失败');
        }
        $(".err_msg").addClass('msg_color');
    }
    //上传成功的回调
    function uploadCallBack(url){
        $(".member_logo").attr('src',url);
        $("#head_pic").attr('src',url);
        $(".err_msg").removeClass("msg_color");
        $(".err_msg").html('上传图片类型必须是jpg,jpeg,gif,png,bmp');
    }
