...
<head>
    ...
    <title>狂欢派对  甜蜜加倍-诺心LECAKE</title>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyXdhfPu.rRz"};</script>
        ...
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
                ...
                <p>
                    <style type="text/css">
                        ...
                        .bg4 {
                            height: 385px;
                            margin-top: -1px;
                            background: url('<%=request.getContextPath()%>/static/images/bg_04.jpg') center no-repeat;
                ...
                <div class="content ">
                    ...
                    <div class="bg2 ">
                        <a href="/shop/goods-100801.html" class="left_img"></a>
                        <a href="/shop/goods-100801.html" class="left_detile"></a>
                        <a href="/shop/goods-102714.html" class="right_img"></a>
                        <a href="/shop/goods-102714.html" class="right_detile"></a>
                    </div>
                    <div class="bg3 ">
                        <a href="/shop/goods-102226.html" class="left_img"></a>
                        <a href="/shop/goods-102226.html" class="left_detile"></a>
                        <a href="/shop/goods-105412.html" class="right_img"></a>
                        <a href="/shop/goods-105412.html" class="right_detile"></a>
                    </div>
                    <div class="bg4 ">
                        <div class="title_txt">
                            <h4>活动规则</h4>
                            <p>活动时间：2018年11月1日至2018年11月25日</p>
                            <p>配送时间：2018年11月2日至2018年11月26日</p>
                            <p>配送区域：诺心可配送区域，具体配送范围及收费标准以下单信息为准。</p>
                            <h4>参与规则</h4>
                            <p>1. 活动期间，正价购买蛋糕馆内任意蛋糕，每笔订单赠半价蛋糕券1张（优惠券在订单配送完成后48小时内到账）。</p>
