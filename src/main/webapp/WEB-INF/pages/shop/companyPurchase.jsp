...
<link href="../static/css/enterprise.css" type="text/css" rel="stylesheet"/>
...
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhpbpcDGWI"};</script>
...
xajax.config.requestURI = "shop/lecake/companyActive.php";
...
xajax_saveGroupPurchase = function() { return xajax.request( { xjxfun: 'saveGroupPurchase' }, { parameters: arguments } ); };
xajax_saveApply = function() { return xajax.request( { xjxfun: 'saveApply' }, { parameters: arguments } ); };
xajax_saveTryEatApply = function() { return xajax.request( { xjxfun: 'saveTryEatApply' }, { parameters: arguments } ); };
/* ]]> */
</script>
...
var objCityList = [];
    ...
    <ul>
        ...
        <li>
            <!---蛋糕馆--->
            <dt><a href="/category-0-1.html"><img alt="蛋糕馆" src="../static/picture/tntoplist2.jpg"></a></dt>
        ...
        <li>
            <!----甜品馆---->
            <dt><a href="/category-1000-1.html"><img alt="甜品馆" src="../static/picture/tntoplist7.jpg"></a></dt>
            <dt class="TN_drop-down">
    ...
    var app_js = {
        ...
        buyItem: function (sku_id, amount, quickBuyFlag, fn) {
            ...
            if (quickBuyFlag) {
            	...
            	<div class="intr_container clearfix" style=" background-color:#fbf2e1; ">
		<div class="intr_title">
			<div class="fill-menu_top">
				<img src="../static/picture/top.jpg" title="" width="980px" height="421px"/>
			</div>
			<div class="enter-fill-in">
				<div class="fill-left">
					<form>
						<div>
							<div class="fill-title-info">
								如果有意进行企业采购合作,想要了解更多的信息,请您填写以下基本信息,我们会及时与您联系.
							</div>
						</div>
						<div class="fill-info">
							<div class="fill-title"><em>*</em>您的姓名：</div>
							<div class="fill-input">
								<input type="text" name="name" class="u-name" id='username'>
							</div>
						</div>

						<div class="fill-info">
							<div class="fill-title"><em>*</em>您的手机：</div>
							<div class="fill-input">
								<input type="text" name="mobile" class="u-cell" id='mobile'>
							</div>
						</div>


						<div class="fill-info">
							<div class="fill-title"><em>*</em>公司名称：</div>
							<div class="fill-input">
								<input type="text" name="c_name" class="cp-name" id='companyName'>
							</div>
						</div>
						
						<div class="fill-info">
							<div class="fill-title"><em>*</em>城市：</div>
							<div class="fill-input">
								<select name="site_id" id="site_id">
																			<option value="2">上海市</option>
																			<option value="287">北京市</option>
																			<option value="355">南京市</option>
																			<option value="447">嘉兴市</option>
																			<option value="334">天津市</option>
																			<option value="356">宁波市</option>
																			<option value="420">广州市</option>
																			<option value="449">成都市</option>
																			<option value="261">无锡市</option>
																			<option value="83">杭州市</option>
																			<option value="386">深圳市</option>
																			<option value="446">绍兴市</option>
																			<option value="228">苏州市</option>
																			<option value="499">重庆市</option>
																	</select>
							</div>
						</div>

						<div class="fill-info_need clearfix">
							<div class="fill-title"><em>*</em>采购需求：</div>
							<div class="fill-textarea">
								<textarea style="max-width:250px;max-height: 155px;" name="msg" class="c-need" id="" cols="20" rows="7" placeholder="请简要描述您的采购需求"></textarea>
							</div>
						</div>

						<div class="sub">
							<input type="button" name="sub" class="submit" value="" onclick='apply.check()'><!-- apply.check() -->
						</div>
				...
				<div class="fill-right">
					<div class="purchaseRule">
						<h3>蛋糕卡购买</h3>
						<p>
							定额（198元、298元、458元）实物蛋糕卡，可用于员工福利、送客户、送领导等。批量购买，享受更多优惠！
						</p>
					</div>
					...
					<div class="purchaseRule">
						<h3>储值卡购买</h3>	
						<p>
							实体储值卡，可充值1000以内任意金额。可用于员工福利、送客户、送领导等。批量购买，享受更多优惠！
							<a href="/shop/help-668.html" style="color: #f00;">预付卡章程>></a>
						</p>
					</div>	
					...
					<div class="purchaseRule">
						<h3>其他服务</h3>	
						<p>
							我们还提供很多个性化的服务，企业员工团购，预付系统服务，月结系统服务，烘焙教室服务等。<br/>如有具体需求，请电话联系或留言咨询。
						</p>
					</div>	

				</div>
			</div>
			<div class="fill-menu_bottom">
				<img src="../static/picture/bottom.png" width="980px" height="326px" title="">
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	check: function(){
		...
		var need = $('.fill-textarea .c-need').val();
		if(need == ''){
			msg += '请填写采购需求<br/>';
		}
	    ...
	    comm_box.loadding();
		if(this.kg == 0){
			xajax_saveGroupPurchase(params);
			this.kg = 1;
		}
	},
	success : function(){
		comm_box.loadding_close();
	    comm_alert('提交成功',1,'/shop/companyPurchase.php'); 
	},
	fail : function(msg){
		comm_box.loadding_close();
		comm_alert(msg);
    ...
    <div class="TN_footercen">
        ...
        <div class="TN_Fone">
            ...
            <p style="margin-right: 5px">
                <p>
                        <a href="/index.html" class="L" onclick="return city.set_city('2','上海市','SH');">上海</a>
