...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "Kycgold0pupU"};</script>
    ...
    <![endif]-->
    <link type="text/css" href="${pageContext.request.contextPath}/static/css/member.css" rel="stylesheet" />

    <script type="text/javascript" charset="UTF-8">
        /* <![CDATA[ */
        try { if (undefined == xajax.config) xajax.config = {}; } catch (e) { xajax = {}; xajax.config = {}; };
        xajax.config.requestURI = "/shop/member_comments.php";
...
<div class="TN_topheader hide">
    ...
    <div class="TN_menu">
        <ul>
            ...
            <li>
                <!---蛋糕馆--->
                <dt><a href="/BJ/category-0-1.html"><img alt="蛋糕馆" src="static/picture/tntoplist2.jpg"></a></dt>
            ...
            <li>
                <!----甜品馆---->
                <dt><a href="/BJ/category-1000-1.html"><img alt="甜品馆" src="${pageContext.request.contextPath}/static/picture/tntoplist7.jpg"></a></dt>
                <dt class="TN_drop-down">
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
                    ...
                    <div class="member">
                        ...
                        <div class="main">
                            ...
                            <div class="member_box">
                                <div style="height:20px;width:695px;">
                                    <table>
                                        <thead>
                                            <tr>

                                                <td style="text-align:center; width:25%;">商品</td>
                                                <td style="text-align:center; width:25%;">评论内容</td>
                                            </tr>
                                            </thead>
                                        <c:forEach items="${list}" var="list">
                                            <thead>
                                            <tr>
                                                <td style="text-align:center; width:25%;">${list.product.name}</td>
                                                <td style="text-align:center; width:25%;">${list.comment}</td>
                                            </tr>
                                            </thead>
                                        </c:forEach>
                                        </table>
            ...
            <script type="text/javascript">
                function doAction(uuid,flg){
                    var data = new Array(uuid,flg);
                    xajax_member(data,2);
                }
                function call_fun(uuid,flg){
                    if(flg == 2){
                        $("#"+uuid+"_comments").html('您的评价：满意');
                    }else if(flg == 1){
                        $("#"+uuid+"_comments").html('您的评价：不满意');
                    }else{
                        $("#"+uuid+"_comments").html('您的评价：基本满意');
                    }
                }
                function doJumpAction(pageNum){
                    var pageIndex = $("#jumpPageIndex").val();
                    if(pageIndex>pageNum){
                        doSearch(pageNum);
                    }else if(pageIndex <= pageNum && pageIndex>0){
                        doSearch(pageIndex);
                    }else{
                        doSearch(1);
                    }
                ...
                function doSearch(pageIndex){
                    self.location="${pageContext.request.contextPath}//shop/member_comments.php?&pageIndex="+pageIndex;
                }
            </script>
        ...
        <script>
            ...
            ud({
                ...
                },"customer":{"nonce":"ZM2c90LZsbE0PlpE","timestamp":1542073555290,"web_token":"7527158","signature":"ACD927D17BA014EE6E7503589C8736B258508C8F","c_cn_pcustID":"7527158","c_cn_clickID":"Kycgold0pupU","c_cn_zzuID":"KyHRa3ClJ3wO"}    });
        </script>
