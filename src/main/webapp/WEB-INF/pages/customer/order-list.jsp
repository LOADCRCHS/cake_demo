    ...
    <section class="top clear_fix">
        ...
        <%--<div class="right">--%>
            <%--<h2>--%>
                ...
                <%--&lt;%&ndash;<span class="pass_card_flag hide">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<a href="/shop/help-625.html">立即开通心享卡&gt;</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</span>&ndash;%&gt;--%>
            <%--</h2>--%>
            <%--<ul class="clear_fix">--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<label>储值卡</label>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href="javascript:void(0)" target="_blank"&ndash;%&gt;--%>
                       <%--&lt;%&ndash;style="cursor: default">￥0</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<label>我的心享值</label>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href="javascript:void(0)" target="_blank"&ndash;%&gt;--%>
                       <%--&lt;%&ndash;style="cursor: default">0</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<label>我的蛋糕卡</label>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href="/shop/member_cake_coupons.html?flg=1"&ndash;%&gt;--%>
                       <%--&lt;%&ndash;target="_blank">0</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<label>我的优惠券</label>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a href="/shop/member_coupons.html?flg=1" target="_blank">0</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                <%--<li>--%>
                    <%--<label>我的积分</label>--%>
