...
<head>
    ...
    <link href="<%=request.getContextPath()%>/static/css/storedcard.css" rel="stylesheet"></head>
<body>
<article class="container main_customer_common main_coupon main_storedCard max_width">
    ...
    <nav class="main_customer_sidebar f_left">
        ...
        <div class="nav_list">
            ...
            <%--</a>--%>
            <%--</p>--%>
            <%--<p><a href="/customer/stored-card.html" class="active"--%>
                  <%--target="_blank">储值卡--%>
            <%--</a>--%>
            <%--</p>--%>
        </div>
    ...
    </nav>        <div class="content" id="storedCard">
    <template>
        <section class="top top_tab clear_fix">
            <!-- 优惠券tab -->
            <div class="public_tab">
                <ul>
                    <li class="active"><span>可使用储值卡</span></li>
                    <li><span>已使用储值卡</span></li>
                </ul>
            </div>
                ...
                <div class="coupon_wrap"
                    ...
                    <div class="coupon_header">
                        ...
                        <div class="inner_info">
                            <p class="price">
                                <small>¥</small>
                                <span>{{parseInt(item.balance)}}</span>
                            </p>
                            <p class="price_desc">
                                <span class="couponName">储值卡余额</span>
                            </p>
                        </div>
                    ...
                    <div class="coupon_middle">
                        <p><span class="desc_title">卡片编号：</span>{{item.cardno}}</p>
                        <p><span class="desc_title">卡片面值：</span>￥{{parseInt(item.monery)}}</p>
                        <p><span class="desc_title">有效期至：</span>{{item.endtime}}</p>
                        <p class="coupon_detail hide">详细说明 ></p>
                    </div>
...
<script src="<%=request.getContextPath()%>/static/js/storedcard.js"></script><!--HPSTAT start-->
<script type="text/javascript">var glbStatConfig={stat_host:"www.lecake.com",click_id: "KyJLKcaX-SRq"};</script>
    ...
    function udeskLoad() {
        if (!udeskReady) {
            ...
            ud({
                ...
                "customer":{"nonce":"bdePUJPiuwc8qSEV","timestamp":1541756762540,"web_token":"7527158","signature":"95C5C434F0648615C0892A0D9F2A9ED931460D81","c_cn_pcustID":"7527158","c_cn_clickID":"KyJLKcaX-SRq","c_cn_zzuID":"KyHRa3ClJ3wO"}                            });
        }
    }
