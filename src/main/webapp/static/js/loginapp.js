var loginApp = new Vue({
    ...
    data: {
        ...
        register: {
            ...
            aliVerify: null,                         //阿里验证对象
            isAliVerify: aliApiCount < 800,                    //是否使用阿里验证
            aliVerifyError: '',                     //阿里验证码错误提示

            captchaImg: GlobalConfig.staticUrl + '/images/grey.gif',                     //图形验证码
    ...
    created: function () {
        ...
        if (!this.isShowBind && utils.getQuery('isRegister')) {
