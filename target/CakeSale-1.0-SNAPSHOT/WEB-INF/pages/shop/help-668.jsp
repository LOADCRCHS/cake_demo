...
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhqMiSaWk3"};</script>
...
<div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
	...
	<p style="margin:0;">
        <style type="text/css">
            ...
            .BDContainer p.company,p.date {
                width: 90%;
                text-align: right;
            }
            .BDContainer p.img_wrap {
                width: 90%;
                margin: auto;
            }
            .BDContainer p.img_wrap img {
                width: 100%;
            }
            .BDContainer p span {
    ...
    <div class="BDContainer">
        <div>
            ...
            <p>
                第一条  
                <span>
        为适应电子支付业务的发展，规范单用途商业预付卡（以下简称单用途卡）的购买、使用行为，
    为社会各界提供全面优质的服务，根据国家法律、法规等规章制度以及行业惯例，特制定本章程。
    </span> 
            </p>
            <p>
                第二条  
                <span>
        单用途卡是诺心食品（上海）有限公司（以下简称发卡企业）发行，
    仅限于本企业平台（官网www.lecake.com、诺心蛋糕app，诺心蛋糕微信商城）上兑付货物及服务的预付凭证。 
    </span>
            </p>
            <p>
                第三条  
                <span>
        本公司发行的蛋糕卡均为不记名卡,有如下面值：
    面值198元，218元、298元， 336元、 458元为不记名卡有效期为自首次售出之日起（或激活之日起）36个月。
    （特殊产品卡具体规则以卡面规定为准）。
    </span>
            </p>
            <p>
                第四条  <span>单用途卡为密码卡。若卡面上设有密码，则在交易时需要输入密码。 </span>
            </p>
            <p>
                第五条  <span>发卡企业、购卡者及其他当事人均须遵守本章程使用单用途卡。</span>
            </p>
            <p>
                第六条  
                <span>
        资金存款制度：规模发卡企业遵循《单用途商业预付卡管理办法（试行）》（商务部令2012年第9号，以下简称《管理办法》）的规定，
    实行资金存管制度。
    </span>
            </p>
            <p>
                ...
                <span>
        本章程涉及的部分名词遵从如下定义：</br>
                    1.“购卡者”（也称持卡者）指购买或使用单用途卡的单位或个人。 </br>
                    2.“记名卡”指由发卡企业发行，该卡具有充值、消费等多种功能。记名卡不得设有效期。 </br>
                    3.“不记名卡”指由发卡企业发行，不具有循环充值功能，卡内余额用完即有发卡企业收回。不记名卡有效期3年。 
    </span>
            </p>
            <h3>第二章  购卡</h3>
            <p>
                第八条  <span>个人、单位或及其代理人均可向发卡企业或及其售卡企业购买单用途卡，且购卡后则视同同意并自愿遵守本章程。</span> 
            </p>
            <p>
                第九条  
                <span>
        实名登记制度：个人或单位购买（含充值，下同）记名卡的，或一次性购买人民币1万元（含）以上不记名卡的，
    要出示有效身份证件，并留存姓名或单位名称、有效身份证件号码和联系方式。</br>
                    个人有效身份证件包括居民身份证、户口簿、军人身份证件、武警身份证件、港澳台居民通行证、护照等。
    单位有效身份证件包括营业执照、事业单位法人证书、税务登记证、组织机构登记代码证等。 </br>
    ...
    以及单位或个人采用非现场方式（通过互联网、邮递、电话等方式）购卡的，须通过银行转账，不得使用现金购买。
    使用转账方式购卡的，发卡企业或售卡企业要对转出、转入账户名称、账号、金额等进行逐笔登记。 
    </span>
            </p>
            <p>
                第十一条  <span>限额发行制度：单张记名卡限额（指卡内余额）不得超过5000元，单张不记名卡限额不得超过1000元。 </span>
            </p>
            <p>
                第十二条  <span>无论以任何形式的支付方式购买本公司不记名卡，本公司将按国家规定开具相应金额的增值税普通发票。</span>
            </p>
            <h3>
                第三章   使用 
            </h3>
            <p>
                第十三条  <span>使用范围：单用途卡限定在发卡企业的官方网站www.lecake.com及官方app、诺心微商城上使用，
    可通过4001-578-578 客服电话进行查询。</span>
            </p>
            <p>
                第十四条  <span>有效期：记名卡不得设有效期，不记名卡有效期不得少于3年。
    发卡企业或售卡企业对超过有效期尚有资金余额的不记名卡应提供激活、
    换卡等配套服务并可根据本章程收取相应的激活、换卡等成本费用。 </span>
            </p>
            <p>
                第十五条  <span>不记名卡不可挂失，持卡者的单用途卡若因二维码损坏无法使用，
    可凭旧卡到发卡企业指定场所更换新卡。记名卡若遗失，可在发卡企业指定场所办理补卡，
    补卡时均需缴纳人民币20元/张的补卡工本费。</span>
            </p>
            <p>
                第十六条   <span>不记名卡可在本公司网站（www.lecake.com） 上查询预付卡余额及消费明细，也可以通过客服电话办理卡片及密码挂失等业务。</span>
            </p>
            <p>
                第十七条  <span>不记名卡不得透支使用；不得用于或变相用于提取现金。</span>
            </p>
            <h3>
                第四章  退货
            </h3>
            <p>
                第十八条  <span>使用单用途卡购买商品后需要退货的，发卡企业确认属于可退货的情形办理退货的，
    发卡企业或受理企业应将资金退至原卡。原单用途卡不存在或退货后卡内资金余额超过单用途卡限额的，
    应退回至持卡人在同一发卡企业的同类单用途卡内。 
    退货金额不足100元（含）的，可支付现金。</span> 
            </p>
            <p>
                第十九条  <span>因发卡人提供的产品属于生鲜易腐产品，故在收货时未提出异议、产品已被使用或产品已经超过保质期等情况的，不能办理退货。</span>
            </p>
            <p>
                第二十条  <span>发卡企业终止兑付未到期单用途卡的，发卡企业和售卡企业应向持卡人提供免费退卡服务，
    并在终止兑付日前至少30日在备案机关指定的媒体上进行公示。</span> 
            </p>
            <h3>
                第五章   退卡
            </h3>
            <p>
                第二十一条    <span>若持卡人要求退卡的，退卡人应是购买预付卡的原购买人，
    并应在发卡人指定场所办理退卡。办理退卡时，个人退卡人应提供与原购卡人一致的有效身份证件，
    企业退卡人应提供加盖公章的退卡申请和营业执照复印件。预付卡退卡人应一并出示并退还购卡的原始发票以及相关的付款凭证。
    如预付卡退卡人要求退还其在购买时享受过任何折扣或优惠的预付卡，在计算退款时将按退卡人在购买（及充值时，如适用）
    时实际支付的金额或按预付卡全额扣除上述优惠后的金额办理退款。如预付卡退卡人购买预付卡可按其年度累计购卡金额享有任何折扣或优惠的，
    在办理退卡后会将退卡金额从其年度累计购卡金额中扣除。</span>
            </p>
            <p>
                第二十二条   <span>退卡手续费统一按原始发票（包括充值发票，如适用）金额10%的标准收取，单张卡手续费最低为人民币20元。
    在扣除前述手续费后，卡内剩余资金将被退至退卡人购买预付卡时使用的银行卡（在使用银行卡购买的情形下）或退卡人同名
    的银行账户内（在使用非银行卡交易形式购卡的情形下）。</span>
            </p>
            <h3>
                第五章 换卡
            </h3>
            <p>
                第二十三条   <span>对于实体预付卡，如因预付卡毁损无法交易或使用而需换卡的，经发卡人指定人员核实确为其所发预付卡且尚有余额，
    持卡人可在发卡人指定的场所办理更换，但应支付换卡手续费。实体预付卡的换卡手续费为每张每次人民币20元，由持卡人支付现金。
    发卡人可要求持卡人出示身份证件及原始发票。</span>
            </p>
            <p>
                第二十四条   <span>自发卡人或售卡企业将预付卡交付给购卡人之时起（若为电子类预付卡，
    发卡人通过电子方式或其他双方约定的方式发送给购卡人即视为交付），预付卡的丢失、
    毁损等一切相关风险转移予购卡人。购卡人/持卡人未妥善保管预付卡导致预付卡污损、遗失、灭失、被盗用等的，应当自行承担损失。</span>
            </p>
            <h3>
                第六章   当事人权利和义务 
            </h3>
            <p>
                第二十五条  <span>发卡企业的权利： <br>
    1.发卡企业为购卡者提供的各种免费增值服务，发卡企业有单方终止的权利，且无须事先征得购卡者同意。<br>
    2.发卡企业若发现单用途卡为伪造的卡片，或发现恶意侵占持卡者金额的行为，将立刻终止该卡片的所有功能，并追究伪造者或侵占者的法律责任。</span>
            </p>
            <p>
                第二十六条  <span>发卡企业的义务：<br>
    1.发卡企业通过网站等提供单用途卡使用的有关资料，包括章程、使用说明等。 <br>
    2.发卡企业按约定通过有关渠道为持卡者提供服务，包括但不限于官方400电话、官网在线客户、在线咨询服务。
    持卡人可以通过咨询400电话及在线客服查询卡内余额。 <br>
    3.发卡企业依法对购卡者的信息承担保密义务，未经当事人同意不得向任何单位或个人披露，但法律、法规和规章另有规定，
    或购卡者与发卡企业另有约定的除外。<br>
    4. 就购卡人购买的预付卡或持卡人充值，发卡人向购卡人或持卡人开具符合国家适用法律、法规规定的发票。
    对于持卡人根据本章程退货取得的新预付卡，发卡人不再开具发票。</span>
            </p>
            <p>
                第二十七条  <span>购卡者（或持卡者，下同）的权利： <br>
    1.购卡者享有按规定使用单用途卡的权利。  <br>
    2.购卡者有权知悉单用途卡的功能、使用方法、收费项目及标准。  <br>
    3.购卡者对单用途卡交易有疑问的，有权在规定时间内向发卡企业提出查询或更正要求。 </span>
            </p>
            <p>
                第二十八条  <span>购卡者的义务： <br>
    1.购卡者未妥善保管，导致单用途卡遗失、灭失的，应当自行承担经济损失。 <br>
    2.购卡者对单用途卡、密码保管不善，导致他人冒用单用途卡造成的经济损失，应当自行承担。 <br>
    3.购卡者不得在发卡企业指定场所以外的其他场所使用单用途卡，购卡者未按约定进行交易造成经济损失的，应当自行承担。 <br>
    4.购卡者不得将单用途卡用于套现、洗钱等违法行为。 </span>
            </p>
            <h3>
                第七章   附则 
            </h3>
            <p>
                第二十九条  <span>任何由本章程引起的争议，双方应协商解决。若自一方书面通知另一方要求协商之日起15日内未能解决，
    则该等争议应交由上海仲裁委员会根据其当时有效的仲裁规则仲裁解决。仲裁庭应由一名仲裁员组成。仲裁应使用中文。
    仲裁裁决是终局的，对双方均具有法律约束力。
    在争议解决过程中，除正在进行仲裁的部分外，本章程的其他部分仍应继续执行。</span>
            </p>
            <p>
                第三十条  <span>因下述原因导致持卡人不能正常使用预付卡的，发卡人/售卡企业对持卡人因此受到的损失不承担责任，
    但发卡人应当协助持卡人解决问题并提供必要的帮助：<br>
    (1) 发卡人运营或结算系统停机维修或维护；<br>
    (2) 电力、电信或银行的系统、设备或网站发生故障、不稳定或升级维护，导致停电、或数据传输不稳定、失败或中断；<br>
    (3) 台风、地震、海啸、洪水、战争、恐怖袭击、暴动、游行示威、行政命令及其他不可抗力原因，造成发卡人不能正常营业，
    或造成其运营或结算系统障碍不能正常运行。</span>
            </p>
            <p>
                第三十一条  <span>发卡人有权对预付卡的使用范围、方式或条件等作出补充规定并通过预付卡本身
    （例如卡面、券面或电子通知等方式）向购卡人/持卡人作出说明，购卡人及持卡人亦应遵守该等规定。
    本章程由发卡企业负责制定、修改和解释，于2017年9月10日正式公布并生效。
    本章程的修改或调整在官网www.lecake.com上公布后即生效，无须另行通知。修改后的条款对所有当事人具有同等约束力。 </span>
            </p>
            <p>
                第三十二条  <span>如本公司变更本章程的，将提前30日在公司官方网站（www.lecake.com）上进行公告。
    新章程涉及新增收费项目、提高收费标准、降低优惠条件等内容的，新章程生效之日起180日内，对原持卡客户按原章程执行。</span>
            </p>
            <p class="company">诺心食品（上海）有限公司</p>
            <p class="date">2017年9月10日</p>
            <p class="img_wrap">
                <img src="../static/picture/prepaidcarddesc.jpg" alt="">
            </p>
        </div>
    </div>
