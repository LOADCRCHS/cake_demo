...
<head>
    ...
    <title>+9.9元领取派对礼包-诺心LECAKE</title>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyXdhlX.1XPr"};</script>
        ...
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
                ...
                <p style="margin:0;"><style type="text/css">
                    ...
                    .BDContainer div a.link_detail {
                        width: 750px;
                        height: 100%;
                    }


                    .BDContainer div a.btn_buy {
                        height: 100px;
                        width: 270px;
                        top: 46%;
                    }

                    .BDContainer div a.link_list {
                        width: 240px;
                        height: 100px;
                        top: 55%;
                    }
                    ...
                    .bg1_north {
                        height: 283px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_01.jpg') center no-repeat;
                    }

                    .bg2_north {
                        height: 347px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_02.jpg') center no-repeat;
                    }

                    .bg3_north {
                        height: 371px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_03.jpg') center no-repeat;
                    }

                    .bg4_north {
                        height: 426px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_04.jpg') center no-repeat;
                    }

                    .bg5_north {
                        height: 341px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_05.jpg') center no-repeat;
                    }

                    .bg6_north {
                        height: 352px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_06.jpg') center no-repeat;
                    }

                    .bg7_north {
                        height: 363px;
                        background: url('<%=request.getContextPath()%>/static/images/bg_north_07.jpg') center no-repeat;
                    }

                    .BDContainer div .rules {
                        position: absolute;
                        text-align: center;
                        left: 50%;
                        top: 0;
                    ...
                    .BDContainer .lp_mask .go_2{
                        width: 200px;
                        height: 50px;
                        position: absolute;
                        top: 61%;
                    }
                    .BDContainer .lp_mask .tips{
                        width: 300px;
                        height: 204px;
                        position: absolute;
                        top:50%;
                ...
                <div class="BDContainer">
                    <div class="bg bg1_north">&nbsp;</div>
                    <div class="bg bg2_north">&nbsp;</div>
                    <div class="bg bg3_north">&nbsp;</div>
                    <div class="bg bg4_north">
                        <a class="link_detail" href="/shop/goods-108682.html">&nbsp;</a>
                    </div>
                    <div class="bg bg5_north">
                        <a class="btn_buy"  data-postId='108682' href="javascript:;">&nbsp;</a>
                    </div>
                    <div class="bg bg6_north">
                        <a class="link_list" href="javascript:;">&nbsp;</a>
                    </div>
                    <div class="bg bg7_north">
                        <div class="rules">
                            <h2>活动规则</h2>
                            <p>活动时间：<span>2018年11月1日至2018年11月29日</span></p>
                            <p>配送时间：<span>2018年11月2日至2018年11月30日</span></p>
                            <p>配送区域：<span>华北诺心可配送区域，具体配送范围及收费标准以下单信息为准。</span></p>
                            <h2>参与规则</h2>
                            <p><span>1. 活动期间，购买蛋糕馆内任意蛋糕，单笔订单加9.9元可购价值58元的派对礼包（B）1份，先到先得。</span></p>
                            <p><span>2. 本活动仅限线上用户参与，不与其它优惠同享（如优惠券、蛋糕卡、储值卡、银行优惠等）。</span></p>
                        </div>
                    </div>
                    <div class="lp_mask hide">
                        <div class="tips">
                            <img src="<%=request.getContextPath()%>/static/picture/pc_succes.png" alt="">
                            <a href="javascript:;" class="go_2 link_list">&nbsp;</a>
                ...
                <script>
                    $(function(){
                        //  跳转蛋糕馆
                        var city_site = get_COOKIE_INFO('CITY_ALIAS'),
                            city_id = get_COOKIE_INFO('CITY_ID'),
                            alwaysCityArr = [287, 334],
                            city_idNum = null,
                            code = null;

                        if (city_id) {
                            city_idNum = city_id.split('_')[1];
                            code = $.inArray(parseInt(city_idNum), alwaysCityArr);
                        }

                        $('.link_list').click(function() {
                            location.href = '/' + city_site + '/category-0-1.html';
                        });
                        // 加购物车
                        $('.btn_buy').click(function () {
                            var postId = $(this).attr('data-postId');
                            app_js.buyItem(postId, 1, false, {
                                success: function () {
                                    if(code == -1) {
                                        comm_alert('该商品未在当前城市上架');
                                    } else {
                                        $('.lp_mask').removeClass('hide');
                                    }
                                }
                            });
                        })
