...
<meta http-equiv="Content-Language" content="zh-CN" />
			<title>联系我们-诺心LECAKE</title>
		<meta name="Keywords" content="诺心线上蛋糕,诺心联系方式,诺心订购电话" />
	<meta name="Description" content="诺心蛋糕精选进口新鲜食材，提供健康、高品质的蛋糕产品。联系诺心蛋糕可拨打订购电话或发邮件。诺心LECAKE蛋糕官网，臻品蛋糕，美味直送到家！" />
...
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhqAFx8hmu"};</script>
...
.break{ margin-bottom:-16px;padding:0;}
p {color: #636363;font-size: 15px;line-height: 24px;}
BODY P {FONT-SIZE: 12px;color: #636363}
BODY TABLE {FONT-SIZE: 12px}
.listQL LI EM {FONT-STYLE: normal;CURSOR: pointer}
.listQL UL, .listQL UL LI A {color: #636363;clear: both;display: block;font-family: "微软雅黑";font-size: 12px;font-weight: bold;color: #515151;}
.listQL UL LI A {height: 20px;padding-bottom: 13px;width: 130px;border-bottom: #515151 dashed 1px;clear: both;}
.listQL UL LI A:hover {color: #83391a}
.listQL font12 {color: #636363}
.listQL OL SUP {MARGIN-LEFT: 10px;FONT-WEIGHT: bold}
.left_menu {border:0;}
.left_menu OL LI {LINE-HEIGHT: 21px}
.left_menu .left_title2 STRONG {LINE-HEIGHT: 31px;PADDING-LEFT: 18px;DISPLAY: block;BACKGROUND: url(../static/images/menu_tit.png) repeat-x;HEIGHT: 31px;COLOR: #333333;FONT-SIZE: 14px}
.left_menu EM {BORDER-BOTTOM: #d4d4d4 1px solid;LINE-HEIGHT: 29px;PADDING-LEFT: 20px;WIDTH: 183px;DISPLAY: block;BACKGROUND: url(../static/images/menu_sub_tit.png) no-repeat;HEIGHT: 29px}
.left_menu EM.on {BACKGROUND: url(../static/images/menu_sub_tit_on.png) no-repeat;COLOR: #cc0000;FONT-WEIGHT: bold}
.left_menu OL LI A {PADDING-LEFT: 10px;BACKGROUND: url(../static/images/listimg.png) no-repeat 0px 7px;color: #636363; margin:0 0 10px 60px;}
.job_list {LINE-HEIGHT: 24px}
TD.font12 {LINE-HEIGHT: 25px;PADDING-LEFT: 10px;HEIGHT: 25px;COLOR: #636363;}
TD.font12 IMG {margin:10px 0 20px 0;}
#jzg {PADDING-LEFT: 20px}
#jzg SPAN {COLOR: #0066cc;FONT-SIZE: 14px}
.red16 {COLOR: #737373;FONT-SIZE: 12px;FONT-WEIGHT: bold;font-family: "微软雅黑";}
.job_item {DISPLAY: none}
.job_item TD { padding:10px 20px;}
.job_item TD P{ font-family: "微软雅黑"; }
.right_top P {LINE-HEIGHT: 24px}
.left_menu .left_title2 .about_title {margin: 77px 0px 25px 40px;width:138px;}

*{ margin:0; padding:0;}
.g-nav{ background-color:#fff;}
body{ background-color:#fff;}
.hside{ margin:22px 0 0 12px; height:520px;}
#homepage_left{background-image: url(../static/images/nx_r3_c2.gif);background-repeat: repeat-y; background-position:12px 22px;}
table{ border-collapse:collapse;}</style>   </meta>
</p>
<div class="body">
<table border="0" cellspacing="0" cellpadding="0" width="980" style="margin: 0px auto">
    <tbody>
        <tr>
            <td colspan="3" style="width: 980px"><img alt="" width="980" height="335" src="../static/picture/0115.jpg" /></td>
        </tr>
        <tr>
            <td id="homepage_left" height="540" valign="top" width="240" style="background-color: #eeeeee">
            <div style="background: #eee; height: 22px; margin-left: 12px">&nbsp;</div>
            <div class="hside">
            <table class="left_menu" border="0" cellspacing="0" cellpadding="0" width="100%">
                <tbody>
                    <tr>
                        <td class="left_title2">
                        <div class="about_title"><img alt="" width="138" height="26" src="../static/picture/nx_r5_c3.gif" /></div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <ul>
                            ...
                            <ol>
                                <li><a href="/shop/help-47.html">诺心故事</a></li>
                                <li><a href="/shop/help-48.html">品牌理念</a></li>
                                <li><a href="/shop/help-4.html">联系我们</a></li>
                                <li><a href="/shop/help-10.html">呼叫中心</a></li>
                            </ol>
                            </li>
                        </ul>
                        </td>
            ...
            <td valign="top" width="728" style="background-color: #fff">
            <table>
                <tbody>
                    <tr>
                        <td>
                        <table class="right_top" style="width: 100%; background: #eee">
                            <tbody>
                                <tr>
                                    <td height="22">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                    <table class="job_list" border="0" cellspacing="0" cellpadding="0" width="100%" style="background-color: #fff">
                                        <tbody>
                                            <tr>
                                                <td class="font12" height="25" valign="bottom" align="left"><img alt="" width="236" height="56" style="margin-top: 30px" src="../static/picture/untitled.png" /></td>
                                            </tr>
                                            <tr class="job_item" style="display: block">
                                                <td align="left">
                                                <div class="red16 ">&nbsp;</div>
                                                <p style="color: #636363; font-size: 14px; font-weight: bold">诺心LE CAKE 爱分享</p>
                                                <div class="break">&nbsp;</div>
                                                <p>我们倡导与您分享优品的诺心LE CAKE幸福滋味。<br />
                                                为了给予您更优质的服务，请拨打诺心LE CAKE的400服务热线提出您的宝贵建议或任何疑问，诺心LE CAKE在此感谢您的信任与支持。</p>
                                                <div class="break">&nbsp;</div>
                                                <!--<p>诺心食品（上海）有限公司徐汇第一分公司</p>-->
                                                <div class="break">&nbsp;</div>
                                                <p><strong>订购电话: </strong>4001-578-578</p>
                                                <p><strong>客服邮箱: </strong>services@lecake.com</p>
                                                <p><strong>地址：</strong>上海徐汇区田林路140号28号楼</p>
                                                <br />
                                                <br />
                                                <br />
                                                <br />
            ...
            <td height="540" width="12" style="background: #eee">&nbsp;</td>
        </tr>
        <tr>
            <td height="12" colspan="3" style="background: #eee">&nbsp;</td>
        </tr>
    </tbody>
</table>
</div>
