...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyJm-zqKcgZ3"};</script>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        xajax.config.requestURI = "/shop/member_editUser.html";
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
                                ...
                                <form  method="post" action="/shop/member_go_editUser.html">
                                    ...
                                    <table class="edit_profile" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td >真实姓名：</td>
                                            <td >
                                                <input name="account" maxlength="40" id="custname" size=20 class="must" value="${user.account}"type="text" />
                                                <span>* </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="b">邮件地址：</td>
                                            <td>
                                                <input name="email" maxlength="80" id="email" size=40 value="${user.email}" class="must" type="text" />
                                                <span>* </span>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="edit_profile" border="0" cellpadding="0" cellspacing="0" width="100%">
										...
										会员将享有生日回馈，填写后将无法修改</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>手机号码：</td>
                                            <td>
                                                <input name="phoneNum" maxlength="20" id="mobile" size=20 class="must" value="${user.phoneNum}" type="text" />
                                                <span>* </span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>QQ &nbsp;账号：</td>
                                            <td>
                                                <input name="qqNum" id="qq" type="text" maxlength="20" size=20 value="${user.qqNum}" />
                                            </td>
                                        </tr>

                                        </tbody>
                                    </table>
                                    <fieldset style="border: 0pt none; text-align: center; margin-top: 25px;">
                                        <input value="更&nbsp;&nbsp;&nbsp;&nbsp;新" style="width: 88px; text-align: center; cursor:pointer;" type="submit" id="formBut" name="formBut" class="mem_btn"/>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
            ...
            <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/edituser.js"></script>
        ...
        <div class="TN_footer hide">
            <div class="TN_footercen">
                ...
                <div class="TN_Fone">
                    ...
                    <!--span class="TN_but_flower"><img src="<%=request.getContextPath()%>/static/picture/tn_footflower4.jpg" width="22" height="24" /></span--->
        ...
        <script>
            ...
            ud({
                ...
                },"customer":{"nonce":"flhGPqNsmkQbHKX5","timestamp":1541763588164,"web_token":"7527158","signature":"4936002F01E865B04B46F8A1182066D03D07626E","c_cn_pcustID":"7527158","c_cn_clickID":"KyJm-zqKcgZ3","c_cn_zzuID":"KyHRa3ClJ3wO"}    });
        </script>
