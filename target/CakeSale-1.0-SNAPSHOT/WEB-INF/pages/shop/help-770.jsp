...
<head>
    ...
    <title>生日就要专“数”定制-诺心LECAKE</title>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyXXGLEWxFQf"};</script>
        ...
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
                ...
                <p style="margin: 0"><style type="text/css">
                    ...
                    .bg1 {
                        background: url("<%=request.getContextPath()%>/static/images/img_01.jpg") no-repeat center;
                        height: 570px;
                    }

                    .bg2 {
                        background: url("<%=request.getContextPath()%>/static/images/img_02.jpg") no-repeat center;
                        height: 469px;
                    }

                    .bg3 {
                        background: url("<%=request.getContextPath()%>/static/images/img_03.jpg") no-repeat center;
                        height: 543px;
                    }
                    .bg4{
                        height: 420px;
                ...
                <div class="BDContainer"><section class="bg bg1">         &nbsp;     </section>     <section class="bg bg2">         <a href="/shop/goods-106135.html" class="link2">&nbsp;</a>     </section>     <section class="bg bg3">         <a href="/shop/goods-102226.html">             <img src="<%=request.getContextPath()%>/static/picture/img_gif.gif" alt="" class="cake_gif" />         </a>         <a href="javascript:;" class="go">&nbsp;</a>     </section>     <section class="bg bg4">
                    <div class="txt txt2">
                        <h3 class="tex_header">活动规则</h3>
                        <p><span class="tex_header">活动时间</span>：2018年11月1日至2018年11月29日</p>
                        <p><span class="tex_header">配送时间</span>：2018年11月2日至2018年11月30日</p>
                        <p><span class="tex_header">配送区域</span>：诺心可配送区域，具体配送范围及收费标准以下单信息为准。</p>
                        <h4 class="tex_header">参与规则</h4>
                        <p>1. 活动期间，用户可享优惠福利：</p>
                        <p>① 单笔订单正价购买2个数字蛋糕，结算时享第2件半价；单笔订单正价购买3个数字蛋糕，结算时享第3件免单。</p>
                        <p>② 正价购买指定款蛋糕1个，加18元即享加大升级。2-4人食蛋糕加大为5-8人食，5-8人食蛋糕加大为10-12人食（适用蛋糕注明&ldquo;+18元升级&rdquo;标签，详见官网蛋糕馆）。</p> <p>温馨提示：以上优惠福利，每笔订单仅享其一，不可同享。</p>
                        <p>2. 本活动仅限线上用户参与，不与其他优惠同享（如优惠券、蛋糕卡、储值卡、银行优惠等）。</p>
                    </div>
                </section></div>
                <script>
                    $(function () {
                        window.onload = function () {
                            ...
                            var city_idArr = city_id.split('_');
                            city_idNum = city_idArr[1];
                            $('.go').prop('href', '/' + city_site + '/category-0-1.html');
                        }
