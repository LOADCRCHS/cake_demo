...
<meta http-equiv="Content-Language" content="zh-CN" />
	<title>企业专区丨大客户登录-诺心LECAKE蛋糕官网</title>
	<meta name="Keywords" content="大客户蛋糕定制,大客户蛋糕预订,大客户登录" />
	<meta name="Description" content="诺心蛋糕精选进口新鲜食材，为大客户提供健康、高品质的蛋糕产品。大客户可登录诺心蛋糕官网，线上预订鲜奶蛋糕、芝士蛋糕、慕斯蛋糕，支持蛋糕货到付款。诺心LECAKE蛋糕官网，臻品蛋糕，美味直送到家！" />
...
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhpidCrTdG"};</script>
...
<![endif]-->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/company_login.css" type="text/css"/>
    
<script type="text/javascript" charset="UTF-8">
/* <![CDATA[ */
try { if (undefined == xajax.config) xajax.config = {}; } catch (e) { xajax = {}; xajax.config = {}; };
xajax.config.requestURI = "/shop/ncompany/nlogin.php";
...
xajax_do_req_ncompany_user = function() { return xajax.request( { xjxfun: 'do_req_ncompany_user' }, { parameters: arguments } ); };
/* ]]> */
</script>
</head>
<body>
...
<script>
    ...
    var app_js = {
		...
		<div class="login-menu">
			<div class="le-user">
			<div class="le-user-box">
				<div class="menu">
					<div class="menu-name">用户名称：</div>
					<div class="name-input"><input type="text" name="text" id="userName" name="userName"></div>
					<div class="name_error" id="userName_error"></div>
				</div>
				<div class="menu">
					<div class="menu-name">密码：</div>
					<div class="pwd-input"><input type="password" name="text" id="pwd" name="pwd"></div>
					<div class="name_error" id="pwd_error"></div>
				</div>				
				<div class="menu">
					<div class="login-button">
						<a href="javascript:void(0);" onclick="doLogin();"></a>
					</div>
				</div>	
				</div>
			</div>			
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/common.js"></script><script type="text/javascript" src="${pageContext.request.contextPath}/static/js/ncompany_login.js"></script>
