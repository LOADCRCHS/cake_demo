...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/tnindexstyle.css"/><!----样式按此顺序排放------>
<script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHhpuFydOzZ"};</script>
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/base_1.css">
<link type="text/css" href="${pageContext.request.contextPath}/static/css/widget_1.css" rel="stylesheet"/>
<!--[if lt IE 9]>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/xajax_core.js" charset="UTF-8"></script>
...
var objCityList = [];
    ...
    <ul>
        <li class="TN_LEFTone">
            <dt><a href="/"><img alt="首页" src="${pageContext.request.contextPath}/static/picture/tntoplist1.jpg"></a></dt><!-----首页1----->
            <dd><a href="/"></a></dd>
        </li>
        <li>
            <!---蛋糕馆--->
            <dt><a href="/SH/category-0-1.html"><img alt="蛋糕馆" src="${pageContext.request.contextPath}/static/picture/tntoplist2.jpg"></a></dt>
        ...
        <li>
            <!----甜品馆---->
            <dt><a href="/SH/category-1000-1.html"><img alt="甜品馆" src="${pageContext.request.contextPath}/static/picture/tntoplist7.jpg"></a></dt>
            <dt class="TN_drop-down">
        ...
        <li class="TN_logo" style=" margin: 0 10px;">
            <img alt="诺心蛋糕" src="${pageContext.request.contextPath}/static/picture/tntoplistlogo.jpg" width="271" height="52" />
        </li>

        <li  style="margin-left: 0px; ">
            <!----我的诺心---->
            <dt><a href="/shop/member_user.php"><img alt="我的诺心" src="${pageContext.request.contextPath}/static/picture/tntoplist3.jpg"></a></dt>
        ...
        <li>
            <!----企业专区---->
            <dt style="cursor: pointer"><img alt="企业专区" src="${pageContext.request.contextPath}/static/picture/tntoplist4.jpg"></dt>
        ...
        <li>
            <!---关于诺心-->
            <dt style="cursor: pointer"><img alt="关于诺心" src="${pageContext.request.contextPath}/static/picture/tntoplist8.jpg"></dt>
            <dd style="cursor: pointer"></dd>
            <dt class="TN_drop-down">
        ...
        <section class="global_nav">
            <div class="main_width clear_fix">
                <div class="f_left logo_wrap">
                    <a href="/">
                        <img src="${pageContext.request.contextPath}/static/picture/logo_new.png" style="height: 20px;"/>
                    </a>
                </div>
                <ul class="nav f_left">
                    <li>
...
<div id="container" style="width:980px; float: left;background-color: #FEFAEC;">
	...
	<p style="margin:0;"><style type="text/css">
    .global_header {
        margin-bottom: 0;
    }

    .TN_BigBoxBG, #container {
        width: 100% !important;
    ...
    .LP_Container .cake_desc span {
        display: block;
        text-align: center;
        font-size: 14px;
    }
    .LP_Container .cake_desc span.sp{
        color: #ff4002;
    }
    .LP_Container .cake_desc span.price{
        font-size: 12px;
    }
    .LP_Container .cake_desc.desc_01 {
        margin-left: -600px;
    }
    .LP_Container .cake_desc.desc_02 {
        margin-left: -295px;
    }
    .LP_Container .cake_desc.desc_03 {
        margin-left: 11px;
    }
    .LP_Container .cake_desc.desc_04 {
        margin-left: 317px;
    }
    .LP_Container .bg {
        position: relative;
    }
    .LP_Container .bg .link-wrap {
        position: relative;
        width: 100%;
        height: 200px;
    }
    .LP_Container .bg .link-wrap .link_01 {
        margin-left: -600px;
    }
    .LP_Container .bg .link-wrap .link_02 {
        margin-left: -295px;
    }
    .LP_Container .bg .link-wrap .link_03 {
        margin-left: 11px;
    }
    .LP_Container .bg .link-wrap .link_04 {
        margin-left: 317px;
    }
    .bg1 {
        height: 360px;
        background: url('${pageContext.request.contextPath}/static/images/cake_01_1.jpg') center no-repeat;
    }
    .bg2 {
        height: 348px;
        background: url('${pageContext.request.contextPath}/static/images/cake_02_1.jpg') center no-repeat;
    }

    .bg3 {
        height: 203px;
        background: url('${pageContext.request.contextPath}/static/images/cake_03_1.jpg') center no-repeat;
    }
    ...
    .bg5 {
        height: 202px;
        background: url('${pageContext.request.contextPath}/static/images/cake_05.jpg') center no-repeat;
    }
    .bg6 {
        height: 109px;
    }
    .bg7 {
        height: 201px;
        background: url('${pageContext.request.contextPath}/static/images/cake_07.jpg') center no-repeat;
    }
    .bg8 {
        height: 108px;
    }
    .bg9 {
        height: 201px;
        background: url('${pageContext.request.contextPath}/static/images/cake_09.jpg') center no-repeat;
    }
    .bg10 {
        height: 155px;
    }
...
<div class="LP_Container" id="LP_Container">
<div class="bg bg1">&nbsp;</div>
<div class="bg bg2">&nbsp;</div>
<div class="bg bg3">
<div class="link-wrap"><a href="/shop/goods-107307.html" class="link_01">&nbsp;</a>             <a href="/shop/goods-107294.html" class="link_02">&nbsp;</a>             <a href="/shop/goods-107305.html" class="link_03">&nbsp;</a>             <a href="/shop/goods-107318.html" class="link_04">&nbsp;</a></div>
</div>
<div class="bg bg4">
<div class="cake_desc desc_01"><span class="sp">【国航套餐】</span>             <span>雪域牛乳芝士蛋糕</span>             <span>Le Cheesecake</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_02"><span class="sp">【国航套餐】</span>             <span>提拉米苏乐脆蛋糕</span>             <span>Tiramisu Crispy</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_03"><span class="sp">【国航套餐】</span>             <span>王子蛋糕</span>             <span>Prince Cake</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_04"><span class="sp">【国航套餐】</span>             <span>雪域蓝莓芝士蛋糕</span>             <span>Blueberry Cheesecake</span>             <span class="sp price">￥426</span></div>
</div>
<div class="bg bg5">
<div class="link-wrap"><a href="/shop/goods-107309.html" class="link_01">&nbsp;</a>             <a href="/shop/goods-107302.html" class="link_02">&nbsp;</a>             <a href="/shop/goods-107323.html" class="link_03">&nbsp;</a>             <a href="/shop/goods-107314.html" class="link_04">&nbsp;</a></div>
</div>
<div class="bg bg6">
<div class="cake_desc desc_01"><span class="sp">【国航套餐】</span>             <span>草莓拿破仑蛋糕</span>             <span>Strawberry Mille-feuilles</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_02"><span class="sp">【国航套餐】</span>             <span>蓝莓拿破仑蛋糕</span>             <span>Blueberry Mille-feuilles</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_03"><span class="sp">【国航套餐】</span>             <span>海盐乳酪芝士蛋糕</span>             <span>Parmesan Cheesecake</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_04"><span class="sp">【国航套餐】</span>             <span>芒果千层拿破仑蛋糕</span>             <span>Mango Mille-feuilles</span>             <span class="sp price">￥426</span></div>
</div>
<div class="bg bg7">
<div class="link-wrap"><a href="/shop/goods-107340.html" class="link_01">&nbsp;</a>             <a href="/shop/goods-107301.html" class="link_02">&nbsp;</a>             <a href="/shop/goods-107334.html" class="link_03">&nbsp;</a>             <a href="/shop/goods-107325.html" class="link_04">&nbsp;</a></div>
</div>
<div class="bg bg8">
<div class="cake_desc desc_01"><span class="sp">【国航套餐】</span>             <span>巧克力四重奏蛋糕</span>             <span>Chocolate Quartet</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_02"><span class="sp">【国航套餐】</span>             <span>和风抹茶红豆蛋糕</span>             <span>Matcha Red bean cake</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_03"><span class="sp">【国航套餐】</span>             <span>雪域大理石芝士蛋糕</span>             <span>Marble Cheesecake</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_04"><span class="sp">【国航套餐】</span>             <span>美刀刀蛋糕</span>             <span>Ms.Golden</span>             <span class="sp price">￥426</span></div>
</div>
<div class="bg bg9">
<div class="link-wrap"><a href="/shop/goods-107330.html" class="link_01">&nbsp;</a>             <a href="/shop/goods-107337.html" class="link_02">&nbsp;</a></div>
</div>
<div class="bg bg10">
<div class="cake_desc desc_01"><span class="sp">【国航套餐】</span>             <span>阿尔蒙麦香蛋糕</span>             <span>Almond Oatmeal Aroma</span>             <span class="sp price">￥426</span></div>
<div class="cake_desc desc_02"><span class="sp">【国航套餐】</span>             <span>阿尔蒙洛克蛋糕</span>             <span>Almond Rocks Cake</span>             <span class="sp price">￥426</span></div>
</div>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/common.js"></script><!---------footer star---------------------------------->
</div><!--  开始标签 <div class="TN_BigBoxBG"> 位于 comm_naviBanner.tpl -->
<div class="TN_footer hide">
    <div class="TN_footercen">

        <div class="TN_Fone">
            <span class="TN_but_logo"><img src="${pageContext.request.contextPath}/static/picture/tn_but_logo.png" width="258" height="55" /></span>
        ...
        <ul>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_l.png" width="52" height="52" />&nbsp;<b>全年无休</b></li>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_e.png" width="52" height="52" />&nbsp;<b>安全配送</b></li>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_c.png" width="52" height="52" />&nbsp;<b>品质保证</b></li>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_a.png" width="52" height="52" />&nbsp;<b>上乘食材</b></li>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_k.png" width="52" height="52" />&nbsp;<b>专业客服</b></li>
            <li><img class="L" src="${pageContext.request.contextPath}/static/picture/tn_round_e.png" width="52" height="52" />&nbsp;<b>企业采购</b></li>
        </ul>
        <p class="TN_Ftow">
            <!--
...
<div id="comm_confirm" class="comm_alert comm_layer hide">
    <table>
        ...
        <tr>
            ...
            <td class="mid_c">
                <div class="pb-b-box">
                    <a title="关闭" class="close-popup" onclick="comm_box.confirm_close(0);" id="aClose_dialog_2" href="javascript:void(0)">关闭</a>
                    <div class="pb-titleg">
                        <strong>提示信息</strong>
                    </div>
                    <div class="pb-content">
...
<div class="online_service hide">
    <a class="service_btn" href="javascript:void(0)" id="online_service">
        ...
        <img class="pop_img service_help" src="${pageContext.request.contextPath}/static/picture/service_help.png" alt="" />
    </a>
    <a class="service_btn" href="javascript:void(0)">
        ...
        <img class="pop_img wechat_qr_code" src="${pageContext.request.contextPath}/static/picture/wechat_qr_code.png" alt="" />
    </a>
</div>
<script>
		...
		<tbody>
			<tr>
				<td style="height: 50px;line-height: 50px;border-bottom: 0px;">
					...
					&nbsp;&nbsp;<img class="hand" src="${pageContext.request.contextPath}/static/picture/btn_ok.jpg" onclick="pop_add_goods_to_cart();" />
				</td>
			</tr>
			<tr>
