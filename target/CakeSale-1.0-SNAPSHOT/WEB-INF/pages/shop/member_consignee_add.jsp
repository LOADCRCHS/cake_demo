...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyN5VCLfqlxe"};</script>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        xajax.config.requestURI = "/shop/member_consignee_add.html";
    ...
    <script type='text/javascript' charset='UTF-8'>
        ...
        xajax_edit_user_info = function() { return xajax.request( { xjxfun: 'edit_user_info' }, { parameters: arguments } ); };
        xajax_member = function() { return xajax.request( { xjxfun: 'member' }, { parameters: arguments } ); };
        xajax_bill_complete = function() { return xajax.request( { xjxfun: 'bill_complete' }, { parameters: arguments } ); };
        xajax_saveCustomerAddress = function() { return xajax.request( { xjxfun: 'saveCustomerAddress' }, { parameters: arguments } ); };
        /* ]]> */
    </script>

    <style type="text/css">
        .member div.main,.member_box{
            overflow: visible;
        }
        /*20170310*/
        }
        ...
        .reslutIco{
            background: url(<%=request.getContextPath()%>/static/images/suggestion-icon_013979b.png) no-repeat;
        ...
        .alert_head{
            ...
            padding: 12px;
            color: #36b4e2;
            border-bottom: 2px solid #36b4e2;
        }
        .alert_msg{
            font-size: 15px;
            padding:10px;
...
<script type="text/javascript">
    $(function(){
        //当页面加载成功后查询所有省份
       // alert("aaa");
        $.get("${pageContext.request.contextPath }/shop/member_consignee_add.html",function(d){
            //alert(d);//数组
            var $pro=$("#proId");
            $(d).each(function(){
                $pro.append($("<option value="+this.id+">"+this.name+"</option>"));
            });
        ...
        $("#proId").change(function(){
            //获取省份对应的值
            var $pid=$(this).val();//pid
            //alert($pid);
            //发送ajax请求
            $.get("${pageContext.request.contextPath }/shop/member_consignee_add_city.html",{"pid":$pid},function(obj){
                //alert(obj);
                var $city=$("#cityId");
...
//        $(".wrapper").css("float","left")
    ...
    <div class="TN_menu">
        <ul>
            ...
            <li>
                <!----甜品馆---->
                <dt><a href="/BJ/category-1000-1.html"><img alt="甜品馆" src="<%=request.getContextPath()%>/static/picture/tntoplist7.jpg"></a></dt>
...
<div id="focus3"><!-----全屏大背景---------->
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div id="container">
                <input type="hidden" id="searchUrl" value="https://lbsyun.lecake.com/suggestion?openargs=eyJnX3BsYXRmb3JtIjoibGVjYWtlIiwiZ19hZ2VudCI6Ikt5SFJhM0NsSjN3TyIsImdfY2xpY2siOiJLeU41VkNMZnFseGUiLCJnX2FjY291bnQiOiI3NTI3MTU4IiwiZ190aW1lIjoxNTQxODE4MjQ1LCJnX3NpZ24iOiIxYzc5MzFmMjFkZTc1NmI2MTM0ZmU1ZTUyNzQzNzhhMyJ9">
                <!--开始-->
                    ...
                    <div class="member">
                        ...
                        <div class="main">
                            ...
                            <div class="member_box">
                                <form name="form_add_consignee" id="form_add_consignee" action="/shop/member_consignee_addAddress.html" method="post">
                                    <%--隐藏用户ID--%>
                                    <input id="deliverID" name="userId" class="render_province" value="${num==1?user1.id:user2.id}" type="hidden" />
                                    <table class="amendinfo" border="0" cellpadding="5" cellspacing="5" width="100%">
                                        <tbody>
                                        <tr>
                                            <td width="16%">收货人：</td>
                                            <td width="84%">
                                                <input class="txtinput" id="custName" name="receiveName" size="20" type="text" value="${address.receiveName}" />&nbsp;<font color="red">*</font>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>省/市：</td>
                                            <td>
                                                <%--<select name="provinceid" style="width:70px;" id="provinceid">
...
<%--
                                                <span id="city_div">
									<select name="cityid" id="cityid" class="comm_select" onchange="deliver.city_change();" style="width:100px;">
										<option value="all">请选择...</option>
										 <option label="徐汇区" value="1">徐汇区</option>
									</select>--%>
								</span>
                                                <%--<span id="region_div">--%>
									<%--<select name="countyid" id="countyid" class="comm_select" onchange="deliver.county_change();" style="width:100px;">--%>
										<%--<option value="all">请选择...</option>--%>
									<%--</select>--%>
								<%--</span>--%>
                                                <span id="town_div" style="display: none">
									<select name="townid" id="townid" class="comm_select" onchange="deliver.town_change();" style="width:100px;">
										<option value="all">请选择...</option>
									</select>
								</span>
                                                <font color="red">*</font>
									...
									如没有区/县可以不用选择
                                                ...
                                                <input type="hidden" id="provinceName"  value="" name="provinceName" />
                                                <input type="hidden" id="cityName" value="" name="cityName" />
                                                <input type="hidden" id="countyName" value="" name="countyName" />
                                                <input type="hidden" id="townName" value="" name="townName" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>收货地址：</td>
                                            <td>
                                                <span class="render_province" id="render_province"></span>
                                                <span class="render_city" id="render_city"></span>
                                                <span class="render_district" id="render_district"></span>
                                                <!--<span class="render_town" id="render_town"><!- -{$deliver->townName}- -></span>-->
                                                <span class="address_dd" style="position: relative;">
                                	<input class="txtinput" id="address" name="detailAddr" style="width: 280px;" type="text" value="${address.detailAddr}" />
                                    ...
                                    <div class="add_alert">
                                        ...
                                        <div class="alert_footer">
                                            <span class="alert_ok">是</span>
                                            <span class="alert_cancel">否</span>
                                        </div>
                                    </div>
                                                    <!-- 地址搜索结束 -->

                                </span>&nbsp;<font color="red">*</font>
                                                <span class="post_notice">请不要填写省市区</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>门牌号：</td>
                                            <td>
                                                <input class="txtinput" maxlength="6" id="roomNo" name="homeNum" size="10" type="text" value="${address.homeNum}" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>手机：</td>
                                            <td>
                                                <input class="txtinput" maxlength="11" id="mobile" name="phoneNum" size="20" type="text" value="${address.phoneNum}" />&nbsp;<!--<font color="red">*</font>-->
                                       ...
                                       <%-- <tr>
                                            <td>固定电话：</td>
                                            <td>
                                                <input class="txtinput" id="phone" name="phone" size="20" type="text" value="" />&nbsp;
                                            </td>
                                        </tr>--%>
                                        <tr>
                                            <td>EMAIL：</td>
                                            <td>
                                                <input class="txtinput" id="email" name="email" size="40" type="text" value="${address.email}" />&nbsp;
                                            </td>
                                        </tr>
                                        ...
                                        <!--<tr>
                                            <td>建筑标志：</td>
                                            <td>
                                                <input class="txtinput" id="symbolBuilder" name="symbolBuilder" size="30" type="text" value="--><!--" />&nbsp;
							</td>
						</tr>-->
                                        <%--<tr>--%>
                                            <%--<td>最佳送货时间：</td>--%>
                                            <%--<td>--%>
                                                <%--<input type="radio" id="bestSendTime" name="bestReceiveTime" value="1" checked="checked" />随时可送&nbsp;--%>
                                                <%--<!--<input type="radio" id="bestSendTime" name="bestSendTime" value="2" />只在工作日送&nbsp;-->--%>

                                                <%--<!--<input type="radio" id="bestSendTime" name="bestSendTime" value="3" />只在周末节假日送&nbsp;-->--%>
                                            <%--</td>--%>
                                        <%--</tr>--%>

                                        <tr>
                                            <td>&nbsp;<input type="hidden" id="action" name="action" value="add" /></td>
                                            <td><input value="提&nbsp;&nbsp;&nbsp;&nbsp;交" class="txtsubmit mem_btn" type="submit" onclick="deliver.add();" /></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </form>
            ...
            <script>
                ...
                function searchAddress(event){
                    ...
                    var searProvince = $("#provinceid").find("option:selected").text();
                    var searCity = $("#cityid").find("option:selected").text();
                    if(searCity == '请选择...'){
                        searCity = '';
                    }
                    ...
                    if (kw != "" && keyCode != 38 && keyCode != 40 && keyCode != 13) {
                        $.ajax({
                            type: "GET",
                            url:searchUrl,
                            data: {'keyword':kw,'region':rg},  //    
                            dataType: "jsonp",
                            ...
                            success:function(data){
                                if(data.data.count==0){
                                    $(".search_result,.addrMask").hide();
                                }
                                if(data && data.error == 0 && data.data != null && data.data.list){
                                    if(data.data.keyword == kw && data.data.region == rg){
                                        $(".search_result").show();
                                        var layer = "<div class='resultDiv'><ul class='resultUl'>";
                                        $.each(data.data.list, function(idx, item) {
                                            // console.log(item.name);
                                            layer += "<li class='resultLi'>" + "<span class='reslutIco'></span>" + "<span class='resultName'>" + item.name + "</span><span class='resultCounty'>" + item.county + "</span></li>";

                                        });
                                        layer += "</ul></div>";
                                        $(".search_result").html(layer);
                                    }
                                }
                            }
                ...
                // 点击建议地址列表中的一个,包括模糊地址弹窗提示
                $(document).on("click",'.resultLi', function(){
                    var searCounty = $("#countyid").find("option:selected").text(),
                        resCounty = $(this).find(".resultCounty").text(),
                        resAddr = $(this).find(".resultName").text();

                    if( searCounty != resCounty ){
                        var alert_msg = '该街道地址所在区与所选择的的区不同，是否切换？';
                        $(".alert_msg").html(alert_msg);
                        $(".add_alert,.alert_mask").show();

                        $(".alert_cancel").on('click',function(){
                            $(".add_alert,.alert_mask").hide();
                            // $("#address").val(resAddr);
                            // $(".search_result").hide();
                        });
                        $(".alert_ok").on('click',function(){
                            $(".add_alert,.alert_mask").hide();
                            $("#address").val(resAddr);
                            $("#countyid").find('option').each(function(i,v){
                                if(v.innerText == resCounty){
                                    $(v).prop("selected","selected");
                                    $("#render_district").text(resCounty);
                                }
                                // console.log(i,v.innerText)
                            });
                            //$(".search_result").hide();
                        });
                    }else{
                ...
                $("body").on("mouseover",".resultLi",function(){
                    $(this).css("background","#ECECEC").siblings(".resultLi").css("background","white");
                });
                ...
                $("body").click(function(e){
                    ...
                    if(tarEle.class != 'search_result' && tarEle.id != 'address'){
                        $(".search_result").hide();
                    }
                });
            ...
            <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/common.js"></script><script type="text/javascript" src="<%=request.getContextPath()%>/static/js/region.js"></script>
            <script type="text/javascript">
                function init(){
                }
            ...
            <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/consigneeadd.js"></script>
            <!---------footer star---------------------------------->
        ...
        <script>
            ...
            ud({
                ...
                },"customer":{"nonce":"HMhLlt7kYMmCzS6M","timestamp":1541818245076,"web_token":"7527158","signature":"645E3E066D619BA81B5E4B040D05F38C5BB2EE20","c_cn_pcustID":"7527158","c_cn_clickID":"KyN5VCLfqlxe","c_cn_zzuID":"KyHRa3ClJ3wO"}    });
        </script>
...
<script>
    ...
    if(flg == 1){
        ...
        $("#cityid").val(cityid);
        deliver.city_change();
        var countyid = $("#countyid").val(countyid);
        deliver.county_change();
        $("#townid").val(townid);
        deliver.town_change();
    }
</script>
