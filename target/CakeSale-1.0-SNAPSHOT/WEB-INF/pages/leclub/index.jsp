...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHdo1-lG4v4"};</script>
    ...
    <![endif]-->
    <link type="text/css" href="<%=request.getContextPath()%>/static/css/activity.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/base_1.css"/>
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/index.css"/>

    <script type="text/javascript" charset="UTF-8">
        /* <![CDATA[ */
        try { if (undefined == xajax.config) xajax.config = {}; } catch (e) { xajax = {}; xajax.config = {}; };
        xajax.config.requestURI = "/shop/index.php";
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/xwindow.css"/>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            iUtil.setConfig({"city": ['2', 'SH']});
        });
        //-->
    </script><script type="text/javascript" src="<%=request.getContextPath()%>/static/js/duihuan.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/xwindow.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            $('.goodsbox li, .bonusbox li').hover(function(){
                $('.rank', this).show();
            }, function() {
                $('.rank', this).hide();
            });
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div class="block">
                <div id="header">
                    <div class="fr">
                        <div class="top"><a href="/SH/i/duihuan/index/index">首页</a>  |  <a href="/SH/i/duihuan/goods/index">积分兑换商品</a>  |  <a href="SH/i/duihuan/coupon/index">积分兑券</a>  |  <a href="/shop/member_user.php">个人中心</a>  |  <a href="/SH/i/duihuan/about/index">LECLUB章程</a></div>
                    </div>
                </div>
            </div><div class="block" id="index_bg">
                <div class="fl index_login">

                    <form name="formLogin" action="/SH/i/login/submit" method="post" onSubmit="return DHUtil.sign(this);">
                        <div class="in">
                            ...
                            <div class="mtb15">
                                ...
                                验证码：<br>
                                <input name="cap" id="cap" class="input" style="width:85px;" /><img src="<%=request.getContextPath()%>/static/picture/yzm.php" id="captcha" style="vertical-align: middle;cursor: pointer; margin-bottom:5px;" onClick="common.captcha(1, 'captcha');" />
                            </div>
                            <div class="mtb15">
                                <input type="checkbox" name="remember" id="remember" value="1">记住用户名 &nbsp;&nbsp;&nbsp;<a href="/customer/find-pw.html">忘记密码</a>
                            </div>
                            <input type="submit" class="submit" value="登录" />
                            <input type="button" class="button" onClick="location.href='/customer/register.html'" value="注册" />
                        </div>
                ...
                <div class="fr">
                    <div class="slider">
                        <div class="window">
                            <div class="image_reel">
                                <a href="http://www.lecake.com/shop/goods-106135.html" style="background:url(<%=request.getContextPath()%>/static/images/15240268919136.jpg) no-repeat center bottom;" target="_blank"></a>
                            </div>
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function(){
                            (function() {
                                var self = $('.slider');
                                $(".paging", self).show().find('a:first').addClass("active");
                                $(".image_reel a", self).css({'width' : 751});

                                var imageWidth = 751;
                                var imageSum = $(".image_reel a").size();
                                var imageReelWidth = imageWidth * imageSum;
                                $(".image_reel", self).css({'width' : imageReelWidth});
                                $(".paging a", self).click(function() {
                                    $(this).addClass('active').siblings().removeClass('active');
                                    $(".image_reel", self).stop(true, true).animate({
                                        "left": -1 * $(this).index() * imageWidth
                                    }, 500);
                                });

                                $(".point_lf", self).click(function() {
                                    var _prev = $(".paging a.active", self).prev();
                                    if (_prev.size() < 1) {
                                        _prev = $(".paging a", self).last();
                                    }
                                    _prev.trigger('click');
                                });

                                $(".point_rt", self).click(function() {
                                    var _next = $(".paging a.active", self).next();
                                    if (_next.size() < 1) {
                                        _next = $(".paging a", self).first();
                                    }
                                    _next.trigger('click');
                                });
            ...
            <div class="block" id="search">
                <div class="in">
                    <form action="/SH/i/duihuan/goods/index" method="get">
                        礼品搜索从 <input name="points[0]" value="" size="10" /> 积分 ~ 到 <input name="points[1]" value="" size="10" /> 积分 &nbsp;&nbsp;&nbsp;
                        礼品名称 <input name="keywords" value=""  /><input type="submit" class="submit" value="搜索" />
                    </form>
                </div>
            </div>
            <a name="goods" />
            <div class="block mt20">
                <div class="linetitle">
                    <div class="fl f22 t_gold" style="line-height:40px;padding-left:10px;">积分兑换商品</div>
                    <div class="fr goodschoose">
                        <a href="/SH/i/duihuan/goods/index?cid=">所有商品</a>
                        |  <a href="/SH/i/duihuan/goods/index?cid=1">诺心蛋糕</a>
                    </div>
                </div>
            </div>
            <div>
                <div id="goodsbox" class="block goodsbox">
                    <li class="fl" rel="103065">
                        <img src="<%=request.getContextPath()%>/static/picture/list_13126.jpg"/>
                        <span class="integral"><div class="iin">1450积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">3700积分</span><Br />限量1998份
                            </div>
                            海盐乳酪芝士蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank103065">
                            <div class="ranks" style="">LEV1：3700积分</div>
                            <div class="ranks" style="">LEV2：2500积分</div>
                            <div class="ranks" style="">LEV3：1900积分</div>
                            <div class="ranks" style="">LEV4：1450积分</div>
                        </div>
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '103065');">加入购物车</a>
                        </div>
                    </li>
                    <li class="fl" rel="108796">
                        <img src="<%=request.getContextPath()%>/static/picture/list_18858.jpg"/>
                        <span class="integral"><div class="iin">1450积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">3700积分</span><Br />限量218份
                            </div>
                            辣么巧流心蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank108796">
                            <div class="ranks" style="">LEV1：3700积分</div>
                            <div class="ranks" style="">LEV2：2500积分</div>
                            <div class="ranks" style="">LEV3：1900积分</div>
                            <div class="ranks" style="">LEV4：1450积分</div>
                        ...
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '108796');">加入购物车</a>
                        </div>
                    </li>
                    <li class="fl" rel="108802">
                        <img src="<%=request.getContextPath()%>/static/picture/list_18864.jpg"/>
                        <span class="integral"><div class="iin">200积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">200积分</span><Br />限量654份
                            </div>
                            公主蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank108802">
                            <div class="ranks" style="">LEV1：￥169+200积分</div>
                            <div class="ranks" style="">LEV2：￥159+200积分</div>
                            <div class="ranks" style="">LEV3：￥149+200积分</div>
                            <div class="ranks" style="">LEV4：￥139+200积分</div>
                        </div>
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '108802');">加入购物车</a>
                        </div>
                    </li>
                    <li class="fl" rel="108799">
                        <img src="<%=request.getContextPath()%>/static/picture/list_18861.jpg"/>
                        <span class="integral"><div class="iin">200积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">200积分</span><Br />限量448份
                            </div>
                            王子蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank108799">
                            <div class="ranks" style="">LEV1：￥169+200积分</div>
                            <div class="ranks" style="">LEV2：￥159+200积分</div>
                            <div class="ranks" style="">LEV3：￥149+200积分</div>
                            <div class="ranks" style="">LEV4：￥139+200积分</div>
                        ...
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '108799');">加入购物车</a>
                        </div>
                    </li>
                    <li class="fl" rel="108790">
                        <img src="<%=request.getContextPath()%>/static/picture/list_18852.jpg"/>
                        <span class="integral"><div class="iin">200积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">200积分</span><Br />限量265份
                            </div>
                            巧克力松露蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank108790">
                            <div class="ranks" style="">LEV1：￥169+200积分</div>
                            <div class="ranks" style="">LEV2：￥159+200积分</div>
                            <div class="ranks" style="">LEV3：￥149+200积分</div>
                            <div class="ranks" style="">LEV4：￥139+200积分</div>
                        ...
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '108790');">加入购物车</a>
                        </div>
                    </li>
                    <li class="fl" rel="108784">
                        <img src="<%=request.getContextPath()%>/static/picture/list_18846.jpg"/>
                        <span class="integral"><div class="iin">200积分<br>起兑</div></span>
                        <div class="desc">
                            <div class="fr tr"><!-- 修改已兑换文字 -->
                                价格：<span class="t_gold f14">200积分</span><Br />限量715份
                            </div>
                            红圆舞蛋糕<span class="f14">&nbsp;</span><br />
                        </div>
                        <div class="rank" id="rank108784">
                            <div class="ranks" style="">LEV1：￥169+200积分</div>
                            <div class="ranks" style="">LEV2：￥159+200积分</div>
                            <div class="ranks" style="">LEV3：￥149+200积分</div>
                            <div class="ranks" style="">LEV4：￥139+200积分</div>
                        ...
                        <div class="carts">
                            <a href="javascript:void(0)" class="atonce" onclick="DHUtil.exchange.addToCart(this, '108784');">加入购物车</a>
                        </div>
                    </li>

                </div>
                <div class="global_page tc" id="goodspage">
                </div>
            </div>
            ...
            <div class="block mt20">
                <div class="linetitle">
                    <div class="fl f22 t_gold" style="line-height:40px;padding-left:10px;">积分兑券</div>
                    <div class="fr bonuschoose">
                        <a href="/SH/i/duihuan/coupon/index?cid=">所有礼券</a>
                        |  <a href="/SH/i/duihuan/coupon/index?cid=1">诺心蛋糕券</a>
                    </div>
                </div>
            </div>
            <div>
                <div id="bonusbox" class="block bonusbox">
                    <li class="fl" rel="7466">
                        <div class="thumb fl">
                            <div class="image"><img src="<%=request.getContextPath()%>/static/picture/14116893562236.jpg" /></div>
                            <div class="dhuan"><a href="javascript:void(0)" onClick="DHUtil.exchange.doSubmit(this, '7466')"></a></div>
                        </div>
                        <div class="rbox">
                            <div class="desc">
                                <p>1、此券订购及配送截止至2018年12月31日<br />
                                    2、凭此券购买诺心任意蛋糕（雪域系列、千层系列、大桔<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大利芝士蛋糕以及部分新品、特价品除外）立减50元<br />
                                    3、每个订单仅限使用一张<br />
                                    4、适用城市：诺心所有可配送范围<br />
                                    5、不能同诺心其他优惠同时使用</p>
                            </div>
                            <div class="noting">
                                <div class="rank" id="rank7466">
                                    <div class="ranks" style="">LEV1：900积分</div>
                                    <div class="ranks" style="">LEV2：650积分</div>
                                    <div class="ranks" style="">LEV3：450积分</div>
                                    <div class="ranks" style="">LEV4：345积分</div>
                                </div>
                                <div class="f26 tc" style="height:60px; line-height:60px; color:#bf9e5b;">345积分起兑</div>
                            </div>
                        </div>
                    </li>
                    <li class="fl" rel="7465">
                        <div class="thumb fl">
                            <div class="image"><img src="<%=request.getContextPath()%>/static/picture/14116894357082.jpg" /></div>
                            <div class="dhuan"><a href="javascript:void(0)" onClick="DHUtil.exchange.doSubmit(this, '7465')"></a></div>
                        </div>
                        <div class="rbox">
                            <div class="desc">
                                <p>1、此券订购及配送截止至2018年12月31日<br />
                                    2、凭此券购买诺心任意蛋糕（雪域系列、千层系列、大桔<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大利芝士蛋糕以及部分新品、特价品除外）立减30元<br />
                                    3、每个订单仅限使用一张<br />
                                    4、适用城市：诺心所有可配送范围<br />
                                    5、不能同诺心其他优惠同时使用</p>
                            </div>
                            <div class="noting">
                                <div class="rank" id="rank7465">
                                    <div class="ranks" style="">LEV1：600积分</div>
                                    <div class="ranks" style="">LEV2：450积分</div>
                                    <div class="ranks" style="">LEV3：375积分</div>
                                    <div class="ranks" style="">LEV4：248积分</div>
                                </div>
                                <div class="f26 tc" style="height:60px; line-height:60px; color:#bf9e5b;">248积分起兑</div>
                            </div>
                        </div>
                    </li>
                    <li class="fl" rel="7464">
                        <div class="thumb fl">
                            <div class="image"><img src="<%=request.getContextPath()%>/static/picture/14116893985278.jpg" /></div>
                            <div class="dhuan"><a href="javascript:void(0)" onClick="DHUtil.exchange.doSubmit(this, '7464')"></a></div>
                        </div>
                        <div class="rbox">
                            <div class="desc">
                                <p>1、此券订购及配送截止至2018年12月31日<br />
                                    2、凭此券购买诺心任意蛋糕（雪域系列、千层系列、大桔<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大利芝士蛋糕以及部分新品、特价品除外）立减20元<br />
                                    3、每个订单仅限使用一张<br />
                                    4、适用城市：诺心所有可配送范围<br />
                                    5、不能同诺心其他优惠同时使用</p>
                            </div>
                            <div class="noting">
                                <div class="rank" id="rank7464">
                                    <div class="ranks" style="">LEV1：400积分</div>
                                    <div class="ranks" style="">LEV2：300积分</div>
                                    <div class="ranks" style="">LEV3：250积分</div>
                                    <div class="ranks" style="">LEV4：178积分</div>
                                </div>
                                <div class="f26 tc" style="height:60px; line-height:60px; color:#bf9e5b;">178积分起兑</div>
                            </div>
                        </div>
                    </li>
                </div>
                <div class="global_page tc" id="bonuspage">
                </div>
            </div>
            <div class="block mt20 story" style="display: none">
                <a href="javascript:void(0)"></a>
                <a href="javascript:void(0)"></a>
            </div>
            <div class="block mt20 foryou"></div>
            <!---------footer star---------------------------------->
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/common.js"></script><script type="text/javascript">
