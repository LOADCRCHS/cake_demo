...
<head>
    ...
    <script type="text/javascript">var glbStatConfig={stat_host:"res.lecake.com",click_id: "KyHdoApSq03B"};</script>
    ...
    <div id="focus2"  class="newbgbox"><!------内容背景第二层--------------->
        <div  class="TN_BigBoxBG " ><!----内容大箱子  结束标签 </div> 位于 comm_footer.tpl -->
            ...
            <div class="block mt20">
                <div class="linetitle">
                    <div class="fl f22 t_gold" style="line-height:40px;">积分兑券</div>
            ...
            <div>
                ...
                <div class="global_page tc" id="bonuspage">
                    <a href="/SH/i/duihuan/coupon/index?page=1">&lt; 上一页</a>
                    <a href="/SH/i/duihuan/coupon/index?page=1">下一页 &gt;</a>
                    <a href="/SH/i/duihuan/coupon/index?page=1" class="point_lf"></a>
                    <a href="/SH/i/duihuan/coupon/index?page=1" class="point_rt"></a>
