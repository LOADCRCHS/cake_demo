...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/css/base_2.css">
                ...
                <div class="login_wrap" v-if="currentForm==='login'">
                    ...
                    <div class="more_login_type" v-show="login.yzmLogin===1">
                        ...
                        <div class="type_list">
                            <a href="javascript:void(0)"
                               class="wx"
                               @click="loginByWx('/customer/union-login.html?return_url=%252Fcustomer%252Findex.html&t=wx')"></a>
                            <a href="/customer/union-login.html?return_url=%2Fcustomer%2Findex.html&t=qq"
                               class="qq"></a>
                        </div>
                    </div>
                </div>
...
<script>
    var lastUrl = '/customer/index.html';
...
<script type="text/javascript">var glbStatConfig={stat_host:"www.lecake.com",click_id: "KyHdoH6ziovK"};</script>
